...
# Keep the package-publish gate directly wired to the static Formula-authority
# boundary; this focused suite owns its complete positive and negative matrix.
...
bash "$REPO_ROOT/.github/scripts/test-classify-pr-staging.sh"
bash "$REPO_ROOT/.github/scripts/test-delete-writable-release.sh"
bash "$REPO_ROOT/.github/scripts/test-require-exact-kandelo-main.sh"
bash "$REPO_ROOT/.github/scripts/test-exact-main-package-publication.sh"
...
bash "$REPO_ROOT/.github/scripts/test-package-generation.sh"
bash "$REPO_ROOT/.github/scripts/test-publish-durable-package-generation.sh"
...
bash "$REPO_ROOT/.github/scripts/test-clone-rejected-merge-candidate.sh"
