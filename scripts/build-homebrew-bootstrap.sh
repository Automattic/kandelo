...
BREW_PATCH_SHA256="faf62befeb70033ea450e88eb1b21427e221030a7f6b6ce932ad2c7c728ac2bc"
...
/opt d 0755 0 0
/opt/kandelo d 0755 0 0
/opt/kandelo/homebrew d 0755 1000 1000
/opt/kandelo/homebrew/bin d 0755 1000 1000
/opt/kandelo/homebrew/etc d 0755 1000 1000
/opt/kandelo/homebrew/etc/homebrew d 0755 1000 1000
...
/usr/bin/brew l 0777 0 0 target=/opt/kandelo/homebrew/bin/brew

archive url=target/homebrew-bootstrap/homebrew-brew.zip base=/opt/kandelo/homebrew fmode=0644 fmode_policy=preserve-executable dmode=0755 uid=1000 gid=1000
