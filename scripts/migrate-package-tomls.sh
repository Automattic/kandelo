...
DEFAULT_REPO_URL="https://github.com/wasm-posix-kernel/wasm-posix-kernel.git"
DEFAULT_INDEX_URL='https://github.com/wasm-posix-kernel/wasm-posix-kernel/releases/download/binaries-abi-v{abi}/index.toml'
