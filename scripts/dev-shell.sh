...
nix_develop=(
    ...
    --keep KANDELO_HOMEBREW_MAIN_SHELL_TAP_ROOT \
    --keep KANDELO_HOMEBREW_MAIN_SHELL_TAP_SHA \
    --keep KANDELO_HOMEBREW_MAIN_SHELL_STRICT \
    --keep KANDELO_HOMEBREW_MAIN_SHELL_SHA256 \
