...
with tempfile.TemporaryDirectory(prefix="kandelo-shell-finalizer-test.") as temporary:
    ...
    assert artifact_lock["inputs"]["shell_config_sha256"] == digest(shell_config_path)
...
with tempfile.TemporaryDirectory(
    ...
    assert "artifact lock is not the exact schema-3 contract" in invalid_schema.stderr
