...
| `F_SETLKW` | Partial | Blocking lock acquisition. Blocking wait queues are not yet implemented; conflicts behave like non-blocking acquisition. No deadlock detection. |
