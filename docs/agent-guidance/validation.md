...
| WebKit browser smoke | `cd apps/browser-demos && npx playwright test test/kandelo-webkit-smoke.spec.ts --project=webkit --grep "Kandelo shell demo boots"` | Safari/WebKit boot compatibility for the Kandelo UI |
