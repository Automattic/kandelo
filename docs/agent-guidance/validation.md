...
| WebKit lazy VFS contract | `cd apps/browser-demos && npx playwright test test/browser-kernel-webkit.spec.ts --project=webkit` | Safari/WebKit browser-host lazy VFS registration ordering |
