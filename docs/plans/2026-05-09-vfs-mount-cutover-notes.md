...
2. `tests/packages/nginx/nginx-wrapper.ts:173`
3. `tests/packages/wordpress/wordpress-server.test.ts:74`
4. `tests/packages/mariadb/run-tests.ts:190`
5. `packages/registry/openssl/test/ssl-basic.test.ts:39`
6. `tests/packages/cpython/debug-test.ts:37`
