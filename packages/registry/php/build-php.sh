...
#
#   sapi/cli/php        → php.wasm     (CLI; no fork instrumentation)
...
# the FPM fork path easier to inspect and instrument. CLI ships the same
# way without fork instrumentation on top.
