 ...
 *   npx tsx packages/registry/cpython/demo/serve.ts [python-args...]
 *
 * Examples:
 *   npx tsx packages/registry/cpython/demo/serve.ts -c "print('Hello from CPython!')"
 *   npx tsx packages/registry/cpython/demo/serve.ts script.py
 *   npx tsx packages/registry/cpython/demo/serve.ts   # interactive REPL (stdin)
 */
