...
set(KANDELO_GLUE_OBJ_DIR "${_TOOLCHAIN_DIR2}/mariadb-glue-objs" CACHE PATH "Directory containing Kandelo glue objects")

set(CMAKE_EXE_LINKER_FLAGS_INIT
  "${WASM32_LINK_FLAGS_STR} ${WASM_POSIX_SYSROOT}/lib/crt1.o ${KANDELO_GLUE_OBJ_DIR}/channel_syscall.o ${KANDELO_GLUE_OBJ_DIR}/compiler_rt.o -lc++ -lc++abi -lc"
)
