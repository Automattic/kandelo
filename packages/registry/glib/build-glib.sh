...
# (consumers that register the GRegex error domain at init need
# g_regex_error_quark to resolve). gdbus and its dependents are excluded
# from gio: taking them further needs a session dbus daemon, which this
...
echo "==> Compiling gio..."
# Upstream gio_sources + gdbus_sources (the gdbus client core) minus:
