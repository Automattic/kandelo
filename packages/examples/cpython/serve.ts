 ...
 *   npx tsx packages/examples/cpython/serve.ts [python-args...]
 *
 * Examples:
 *   npx tsx packages/examples/cpython/serve.ts -c "print('Hello from CPython!')"
 *   npx tsx packages/examples/cpython/serve.ts script.py
 *   npx tsx packages/examples/cpython/serve.ts   # interactive REPL (stdin)
 */
