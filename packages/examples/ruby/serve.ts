 ...
 *   npx tsx packages/examples/ruby/serve.ts [ruby-args...]
 *
 * Examples:
 *   npx tsx packages/examples/ruby/serve.ts -e "puts 'Hello from Ruby!'"
 *   npx tsx packages/examples/ruby/serve.ts script.rb
 *   npx tsx packages/examples/ruby/serve.ts -e "p RUBY_VERSION"
 */
