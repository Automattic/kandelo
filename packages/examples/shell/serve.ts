 ...
 *   1. Command: npx tsx packages/examples/shell/serve.ts -c "echo hello"
 *   2. Piped:   echo "echo hello" | npx tsx packages/examples/shell/serve.ts
 *   3. Script:  npx tsx packages/examples/shell/serve.ts script.sh
 *
 * Build dash first:
