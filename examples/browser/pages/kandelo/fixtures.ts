...
export const PRESET_LIBRARY: Preset[] = [
  { id: "shell", title: "Shell sandbox", summary: "A dash shell with coreutils. The minimal Kandelo.",
    base: "kandelo:shell@abi8",
    packages: ["dash@sha256:f4e2…", "coreutils@sha256:9a3c…", "less@sha256:b711…"],
    accent: "#dc6529", glyph: "sh", bootCommand: ["/bin/sh"], estimatedUrlBytes: 312 },
  { id: "python", title: "Python 3.13", summary: "CPython REPL with stdlib. Ready for scripting and small services.",
    base: "kandelo:shell@abi8",
    packages: ["dash@sha256:f4e2…", "coreutils@sha256:9a3c…", "python@sha256:0c14…"],
    accent: "#386a8a", glyph: "py", bootCommand: ["/usr/bin/python3"], estimatedUrlBytes: 564 },
  { id: "wordpress", title: "WordPress 6.7", summary: "nginx + PHP-FPM + SQLite. A full WordPress instance per URL.",
    base: "kandelo:shell@abi8",
    packages: ["nginx@sha256:7c11…", "php-fpm@sha256:a912…", "wordpress@sha256:1e3f…"],
    accent: "#21759b", glyph: "wp", bootCommand: ["/usr/sbin/dinit", "lamp"], estimatedUrlBytes: 1284 },
  { id: "lamp", title: "LAMP", summary: "nginx + PHP + MariaDB. Bring your own app.",
    base: "kandelo:shell@abi8",
    packages: ["nginx@sha256:7c11…", "php-fpm@sha256:a912…", "mariadb@sha256:55cd…"],
    accent: "#5fc481", glyph: "L+", bootCommand: ["/usr/sbin/dinit", "lamp"], estimatedUrlBytes: 1442 },
  { id: "nethack", title: "NetHack 3.6.7", summary: "Classic roguelike with curses UI. Full save support.",
    base: "kandelo:shell@abi8",
    packages: ["nethack@sha256:b042…"],
    accent: "#c98a0e", glyph: "NH", bootCommand: ["/usr/games/nethack"], estimatedUrlBytes: 478 },
  { id: "doom", title: "fbDOOM", summary: "id Software's DOOM rendering directly to /dev/fb0.",
    base: "kandelo:shell@abi8",
    packages: ["fbdoom@sha256:f0d1…", "doom-shareware@sha256:31a0…"],
    accent: "#b5301c", glyph: "D", bootCommand: ["/usr/games/fbdoom"], estimatedUrlBytes: 1018 },
  { id: "quickjs", title: "QuickJS-NG", summary: "ES2023 JavaScript engine with a Node.js compat layer.",
    base: "kandelo:shell@abi8",
    packages: ["quickjs@sha256:55ee…"],
    accent: "#d4b94c", glyph: "JS", bootCommand: ["/usr/bin/qjs"], estimatedUrlBytes: 386 },
  { id: "vim", title: "Vim 9.1", summary: "Full ncurses editor for editing files on the road.",
    base: "kandelo:shell@abi8",
    packages: ["vim@sha256:0c0e…", "coreutils@sha256:9a3c…"],
    accent: "#018643", glyph: "vi", bootCommand: ["/usr/bin/vim", "/home/user/README.md"], estimatedUrlBytes: 624 },
];
