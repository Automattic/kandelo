...
// Source: test/phase2-fixtures/js-varargs.tq
// DO NOT EDIT.
...
Address Builtin_TorqueCcTest_JsVarargs(int args_length, Address* args_object,
  ...
  USE(context);
  Tagged<JSAny> parameter1 = Cast<JSAny>(*args.receiver());
  USE(parameter1);
  Tagged<JSAny> receiver = parameter1;
  USE(receiver);
...
inline Tagged<Smi> TqRuntimeConvert_Smi_intptr_0(intptr_t p_i) {
  ...
  block0:
  tmp0 = TorqueRuntimeMacroShims::CodeStubAssembler::SmiTag(p_i);
  goto block2;
