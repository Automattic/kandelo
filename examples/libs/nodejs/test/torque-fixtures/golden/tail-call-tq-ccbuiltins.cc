...
// Source: test/phase2-fixtures/tail-call.tq
// DO NOT EDIT.
...
Tagged<Smi> Builtin_TorqueCcTest_TailCall_Helper(Isolate* isolate, Tagged<Context> context, Tagged<Smi> x) {
  USE(isolate);
...
Tagged<Smi> Builtin_TorqueCcTest_TailCall(Isolate* isolate, Tagged<Context> context, Tagged<Smi> arg) {
  USE(isolate);
  Tagged<Context> parameter0 = context;
  USE(parameter0);
  ...
  block0:
  return Builtin_TorqueCcTest_TailCall_Helper(Isolate::Current(), parameter0, parameter1);
}
