...
Tagged<Smi> TqRuntimeTorqueCcTest_GotoExternalBody_0(Tagged<Smi> p_x, bool* label_Fail);
...
Tagged<Smi> Builtin_TorqueCcTest_GotoExternal(Isolate* isolate, Tagged<Context> context, Tagged<Smi> arg) {
  ...
  block0:
  tmp0 = TqRuntimeTorqueCcTest_GotoExternalBody_0(parameter1, &label1);
  if (label1) {
    goto block4;
  }
  goto block3;
...
#ifndef V8_INTERNAL_DEFINED_TqRuntimeTorqueCcTest_GotoExternalBody_0
#define V8_INTERNAL_DEFINED_TqRuntimeTorqueCcTest_GotoExternalBody_0

// https://source.chromium.org/chromium/chromium/src/+/main:v8/test/phase2-fixtures/goto-external.tq?l=17&c=3
inline Tagged<Smi> TqRuntimeTorqueCcTest_GotoExternalBody_0(Tagged<Smi> p_x, bool* label_Fail) {
  Tagged<Smi> tmp0{}; USE(tmp0);
  bool tmp1{}; USE(tmp1);
  goto block0;
...
#endif // V8_INTERNAL_DEFINED_TqRuntimeTorqueCcTest_GotoExternalBody_0
