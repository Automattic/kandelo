import{k as D,B as U}from"./browser-kernel-DeZfH_RD.js";/* empty css               */import{S as H}from"./terminal-panel-sc5ZsZwc.js";import{n as P,p as k}from"./nginx-Cq4QJjHN.js";import{p as y,a as W}from"./php-fpm-Deu4FVBk.js";import{C as v,p as C,d as R,a as _,w as B}from"./shell-binaries-DvtU7PcP.js";import{l as N}from"./wp-bundle-CEfoOdTg.js";import{d as F,c as M,g as z,s as G}from"./sed-CaEQBVG8.js";import"./xterm-CyPUMFhC.js";const $="/wasm-posix-kernel/app/",L="/wasm-posix-kernel/app",u=window.location.protocol==="https:"?"https":"http",K="/wasm-posix-kernel/service-worker.js",d=document.getElementById("log"),h=document.getElementById("start"),A=document.getElementById("reload"),E=document.getElementById("status"),V=document.getElementById("terminal-panel");let b=document.getElementById("frame");const x=new TextDecoder;function r(t,n){const a=document.createElement("span");n&&(a.className=n),a.textContent=t,d.appendChild(a),d.scrollTop=d.scrollHeight}function o(t,n){E.style.display="block",E.textContent=t,E.className=`status ${n}`}const Y=`        location / {
...
if (isset($_SERVER['HTTP_HOST'])) {
    ...
    define('WP_HOME', '${u}://' . $_SERVER['HTTP_HOST'] . '${L}');
    define('WP_SITEURL', '${u}://' . $_SERVER['HTTP_HOST'] . '${L}');
}
...
`,"info");try{s.fs.unlink("/var/www/html/wp-content/database/wordpress.db")}catch{}B(s.fs,"/var/www/html/wp-config.php",q),B(s.fs,"/var/www/html/wp-content/mu-plugins/wasm-optimizations.php",Q),o("WordPress running!","running"),A.disabled=!1,I()}}}),await O.boot()}catch(t){r(`
Error: ${t}
