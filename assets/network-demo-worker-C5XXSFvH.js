...
var ri = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-Cj4rt04-.js").then((e) => a(e.default, 1));
...
async function Fs(e, t, n) {
	...
	}(e, t.rootfs, n.machine, n.address), h = new oi("/kandelo/assets/worker-entry-browser-BrpivRLH.js");
	let d, f;
		...
		try {
			const e = await async function() {
				return Ss || (Ss = Promise.all([
					...
					Rs("/kandelo/assets/rootfs-BjDk8qc0.vfs"),
