...
function X(e, t) {
	switch (e) {
		...
		case T:
		case W:
		case K: return G(t, 16);
		case B:
		case N: return G(t, 20);
		case E: return G(t, 24);
		case 256:
		case 257:
		case 512:
		case 513:
		...
		case 259: return q(t, 12, 4);
		case 260: return q(t, 12, 8);
		case 515:
		case 516: return q(t, 36, 32);
		case 769: return q(t, 8, 4);
		case 776: return q(t, 12, 8);
...
const Vt = 67108864;
const Ht = 11, Gt = _e, qt = Fe, jt = Xe, Xt = et, Yt = Ce, Jt = ot, Zt = at, Qt = qe, en = rt, tn = it, nn = wt, sn = st, rn = bt, on = nt, an = xe, cn = re, ln = le, hn = oe, dn = ae, fn = ce, un = tt, gn = ve, pn = It, mn = We, yn = Ke, wn = Qe, bn = lt, kn = vt, In = 16777216, vn = Ne, xn = Pe, _n = Be, Pn = Ue, Bn = Ye, Un = ct, An = ue, Sn = fe, Mn = Oe, En = Re, Cn = Me, Tn = Ee, zn = Te, On = ze, Rn = Je, Fn = Ze, Ln = Ae, Nn = kt, $n = Se, Dn = $e, Wn = De, Kn = dt, Vn = ft, Hn = pe, Gn = pt, qn = mt, jn = yt, Xn = ut, Yn = gt, Jn = "undefined" != typeof process && !!{}.WASM_POSIX_PROFILE, Zn = new Set([
	fe,
	Ee,
	ze,
	Oe,
...
var ii = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-JwEs5mKK.js").then((e) => a(e.default, 1));
	...
	formatSyscallEntry(e, t, n) {
		...
		switch (t) {
			...
			case Ge: return `[${s}${o}] readlinkat(${n[0]}, "${this.readCString(e.memory, n[1])}", ${n[3]})`;
			...
			case Ce: return `[${s}${o}] poll(${n[1]}, ${n[2]})`;
	...
	handleSyscall(e) {
		try {
			...
			console.error(`[handleSyscall] UNCAUGHT ERROR pid=${e.pid}:`, Ci), this.completeChannelRaw(e, -5, 5), this.relistenChannel(e);
		}
	}
	_handleSyscallInner(e) {
		...
		if (n === qn) return void this.handleIpcShmat(e, i);
		if (n === jn) return void this.handleIpcShmdt(e, i);
		if (n === Gn) return void this.handleSemctl(e, i);
		...
		try {
			...
			c && console.error(l + " = KERNEL THROW"), console.error(`[handleSyscall] kernel threw for pid=${e.pid} syscall=${n} args=[${i}]:`, Ci), this.completeChannelRaw(e, -5, 5), this.relistenChannel(e);
			return;
		} finally {
	...
	handleLargeWrite(e, t, n) {
		...
		for (; u < r;) {
			...
			try {
				...
				console.error(`[handleLargeWrite] kernel threw for pid=${e.pid}:`, Ci), u > 0 ? this.completeChannelRaw(e, u, 0) : this.completeChannelRaw(e, -5, 5), this.relistenChannel(e);
				return;
			} finally {
				this.currentHandlePid = 0;
			}
	...
	handleLargeRead(e, t, n) {
		...
		for (; u < r;) {
			...
			try {
				...
				console.error(`[handleLargeRead] kernel threw for pid=${e.pid}:`, Ci), u > 0 ? this.completeChannelRaw(e, u, 0) : this.completeChannelRaw(e, -5, 5), this.relistenChannel(e);
				return;
			} finally {
				this.currentHandlePid = 0;
			}
	...
	handleFork(e, t) {
		...
		if (h) try {
			...
			const s = Ci instanceof Error ? Ci.message : String(Ci);
	...
	sendSignalToProcess(e, t) {
		...
		try {
			...
			console.error(`[sendSignalToProcess] kernel threw for pid=${e} sig=${t}: ${Ci}`);
		} finally {
			this.currentHandlePid = 0;
		}
	...
	handleSemctl(e, t) {
		...
		if (2 === o && 0 !== r) {
			a.setUint32(4, Gn, !0), a.setBigInt64(8, BigInt(n), !0), a.setBigInt64(16, BigInt(i), !0), a.setBigInt64(24, BigInt(s), !0), a.setBigInt64(32, BigInt(h), !0), a.setBigInt64(40, BigInt(0), !0), a.setBigInt64(48, BigInt(0), !0), l.fill(0, h, h + 72), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
			try {
		...
		if (13 === o && 0 !== r) {
			const t = 1024;
			a.setUint32(4, Gn, !0), a.setBigInt64(8, BigInt(n), !0), a.setBigInt64(16, BigInt(i), !0), a.setBigInt64(24, BigInt(s), !0), a.setBigInt64(32, BigInt(h), !0), a.setBigInt64(40, BigInt(0), !0), a.setBigInt64(48, BigInt(0), !0), l.fill(0, h, h + t), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
			try {
				c(this.toKernelPtr(this.scratchOffset), e.pid);
			} finally {
				this.currentHandlePid = 0;
		...
		if (17 === o && 0 !== r) {
			...
			l.set(o.subarray(r, r + t), h), a.setUint32(4, Gn, !0), a.setBigInt64(8, BigInt(n), !0), a.setBigInt64(16, BigInt(i), !0), a.setBigInt64(24, BigInt(s), !0), a.setBigInt64(32, BigInt(h), !0), a.setBigInt64(40, BigInt(0), !0), a.setBigInt64(48, BigInt(0), !0), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
			try {
				c(this.toKernelPtr(this.scratchOffset), e.pid);
			} finally {
				this.currentHandlePid = 0;
		...
		a.setUint32(4, Gn, !0), a.setBigInt64(8, BigInt(n), !0), a.setBigInt64(16, BigInt(i), !0), a.setBigInt64(24, BigInt(s), !0), a.setBigInt64(32, BigInt(r), !0), a.setBigInt64(40, BigInt(0), !0), a.setBigInt64(48, BigInt(0), !0), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
		try {
			c(this.toKernelPtr(this.scratchOffset), e.pid);
		} finally {
			this.currentHandlePid = 0;
	...
	handleIpcShmat(e, t) {
		...
		try {
			...
			console.error(`[handleIpcShmat] mmap failed for pid=${e.pid}:`, Ci), this.completeChannelRaw(e, -12, 12), this.relistenChannel(e);
			return;
		} finally {
			this.currentHandlePid = 0;
		}
...
var ui = class {
	...
	attachMachine(e) {
		const t = hi(e.address instanceof Uint8Array ? e.address : new Uint8Array(e.address)), n = li(t);
		if (this.addressOwners.has(n)) throw new Error(`address ${n} is already attached`);
		const i = new pi(this, e.id, t);
	...
	detachMachine(e) {
		...
		if (t) {
			this.addressOwners.delete(li(t.localAddress)), this.machines.delete(e);
			for (const [n, i] of this.hostnames) li(i) !== li(t.localAddress) && n !== e || this.hostnames.delete(n);
	...
	listenTcp(e, t, n, i, s) {
		...
		for (const o of this.tcpListeners) if (o.machineId === e && o.port === i && fi(o.addrKey, r)) return 98;
	...
	connectTcp(e, t, n) {
		const i = li(n.addr), s = this.addressOwners.get(i);
		if (!s) return {
			peer: new ui(),
			status: 113
		};
		const r = this.tcpListeners.find((e) => e.machineId === s && e.port === n.port && di(e.addrKey, i));
		if (!r) return {
			peer: new ui(),
			status: 111
		};
		const o = new ui(), a = new ui();
	...
	bindUdp(e, t, n, i, s) {
		const r = li(n);
		if (!this.machineOwnsAddress(e, r)) return 99;
		for (const o of this.udpEndpoints) if (o.machineId === e && o.port === i && fi(o.addrKey, r)) return 98;
	...
	sendDatagram(e) {
		const t = li(e.dstAddr), n = this.addressOwners.get(t);
		if (!n) return 113;
		const i = this.udpEndpoints.find((i) => i.machineId === n && i.port === e.dstPort && di(i.addrKey, t));
		return i ? i.target.receive({
			srcAddr: hi(e.srcAddr),
			srcPort: e.srcPort,
			dstAddr: hi(e.dstAddr),
			dstPort: e.dstPort,
			data: e.data.slice()
		}) : 111;
	}
	machineOwnsAddress(e, t) {
		return t === ci || this.addressOwners.get(t) === e;
	}
	trackTcpPeer(e, t) {
	...
	connectStatus(e) {
		...
		return void 0 !== t ? t : this.connections.has(e) ? 0 : ai;
	}
	send(e, t, n) {
		const i = this.connections.get(e);
		if (!i) throw Object.assign(/* @__PURE__ */ new Error("ENOTCONN"), { errno: ai });
		return i.send(t, n);
	}
	recv(e, t, n) {
		const i = this.connections.get(e);
	...
	poll(e, t) {
		...
		if (!n) throw Object.assign(/* @__PURE__ */ new Error("ENOTCONN"), { errno: ai });
...
var vi = class {
	...
	constructor() {
		...
		this.devices.set("null", mi), this.devices.set("zero", yi), this.devices.set("urandom", e), this.devices.set("random", e), this.devices.set("console", wi), this.devices.set("tty", wi), this.deviceNames = [...this.devices.keys()];
	}
	getDevice(e) {
	...
	statfs(e) {
		...
		return t.files = this.devices.size + bi.length + ki.length, t;
	}
	mkdir(e, t) {
	...
	opendir(e) {
		...
		let n;
		if (Ii(e)) n = [...this.deviceNames.map((e, t) => ({
			name: e,
			type: 2,
			ino: t + 1
		})), ...ki.filter((e) => !this.devices.has(e.name))];
		else {
			if (!bi.includes(t)) throw new Error("ENOTDIR");
			n = [];
		}
...
}, xi = ArrayBuffer, _i = Uint8Array, Pi = Uint16Array, Bi = Int16Array, Ui = Int32Array, Ai = function(e, t, n) {
	if (_i.prototype.slice) return _i.prototype.slice.call(e, t, n);
	(null == t || t < 0) && (t = 0), (null == n || n > e.length) && (n = e.length);
	var i = new _i(n - t);
	return i.set(e.subarray(t, n)), i;
}, Si = function(e, t, n, i) {
	if (_i.prototype.fill) return _i.prototype.fill.call(e, t, n, i);
	for ((null == n || n < 0) && (n = 0), (null == i || i > e.length) && (i = e.length); n < i; ++n) e[n] = t;
	return e;
}, Mi = function(e, t, n, i) {
	if (_i.prototype.copyWithin) return _i.prototype.copyWithin.call(e, t, n, i);
	...
	var i = new Error(t || Ei[e]);
	if (i.code = e, Error.captureStackTrace && Error.captureStackTrace(i, Ci), !n) throw i;
	return i;
}, Ti = function(e, t, n) {
	...
	if (3126568 == s && 253 == e[3]) {
		...
		8 & r && Ci(0);
		var h = 6 - o, d = 3 == c ? 4 : c, f = Ti(e, h, d), u = l ? 1 << l : o, g = Ti(e, h += d, u) + (1 == l && 256), p = g;
		if (!o) {
			var m = 1 << 10 + (e[5] >> 3);
			p = m + (m >> 3) * (7 & e[5]);
		}
		p > 2145386496 && Ci(1);
		var y = new _i((1 == t ? g || p : t ? 0 : p) + 12);
	...
	s > n && Ci(3);
	for (var r = 1 << s, o = r, a = -1, c = -1, l = -1, h = r, d = new xi(512 + (r << 2)), f = new Bi(d, 0, 256), u = new Pi(d, 0, 256), g = new Pi(d, 512, r), p = 512 + (r << 1), m = new _i(d, p, r), y = new _i(d, p + r); a < 255 && o > 0;) {
		var w = Oi(o + 1), b = i >> 3, k = (1 << w + 1) - 1, I = (e[b] | e[b + 1] << 8 | e[b + 2] << 16) >> (7 & i) & k, v = (1 << w) - 1, x = k - o - 1, _ = I & v;
	...
	73,
	2
]), 0, 5)[1], $i = function(e, t) {
	for (var n = e.length, i = new Ui(n), s = 0; s < n; ++s) i[s] = t, t += 1 << e[s];
	return i;
}, Di = new _i(new Ui([
	0,
	0,
	...
	202050057,
	269422093
]).buffer, 0, 36), Wi = $i(Di, 0), Ki = new _i(new Ui([
	0,
	0,
	0,
	0,
	...
	252579084,
	16
]).buffer, 0, 53), Vi = $i(Ki, 3), Hi = function(e, t, n) {
	var i = e.length, s = t.length, r = e[i - 1], o = (1 << n.b) - 1, a = -n.b;
	r || Ci(0);
	for (var c = 0, l = n.b, h = (i << 3) - 8 + Oi(r) - l, d = -1; h > a && d < s;) {
		var f = h >> 3;
	...
	Hi(e.subarray(i, i += e[0] | e[1] << 8), t.subarray(0, s), n), Hi(e.subarray(i, i += e[2] | e[3] << 8), t.subarray(s, r), n), Hi(e.subarray(i, i += e[4] | e[5] << 8), t.subarray(r, o), n), Hi(e.subarray(i), t.subarray(o), n);
}, qi = function(e, t, n) {
	...
	if (1 == o) {
		...
		return t.b = s + 1, n ? (Si(n, e[s], t.y, t.y += a), n) : Si(new _i(a), e[s]);
	}
	if (!(c > e.length)) {
		if (0 == o) return t.b = c, n ? (n.set(e.subarray(s, c), t.y), t.y += a, n) : Ai(e, s, c);
		if (2 == o) {
			...
			var p = n ? n.subarray(t.y, t.y + t.m) : new _i(t.m), m = p.length - f;
			if (0 == h) p.set(e.subarray(s, s += f), m);
			else if (1 == h) Si(p, e[s++], m);
			else {
				var y = t.h;
				if (2 == h) {
					var w = function(e, t) {
						var n = 0, i = -1, s = new _i(292), r = e[t], o = s.subarray(0, 256), a = s.subarray(256, 268), c = new Pi(s.buffer, 268);
						if (r < 128) {
							var l = Ri(e, t + 1, 6), h = l[0], d = l[1], f = h << 3, u = e[t += r];
							u || Ci(0);
							for (var g = 0, p = 0, m = d.b, y = m, w = (++t << 3) - 8 + Oi(u); !((w -= m) < f);) {
								var b = w >> 3;
						...
						var I = 0;
						for (n = 0; n < i; ++n) (P = o[n]) > 11 && Ci(0), I += P && 1 << P - 1;
						var v = Oi(I) + 1, x = 1 << v, _ = x - I;
						for (_ & _ - 1 && Ci(0), o[i++] = Oi(_) + 1, n = 0; n < i; ++n) {
							var P = o[n];
							++a[o[n] = P && v + 1 - P];
						}
						var B = new _i(x << 1), U = B.subarray(0, x), A = B.subarray(x);
						for (c[v] = 0, n = v; n > 0; --n) {
							var S = c[n];
							Si(A, n, S, c[n - 1] = S + a[n] * (1 << v - n));
						}
						for (c[0] != x && Ci(0), n = 0; n < i; ++n) {
							var M = o[n];
							if (M) {
								var E = c[M];
								Si(U, n, E, c[M] = E + (1 << v - M));
							}
						}
						return [t, {
							n: A,
				...
				(g ? Gi : Hi)(e.subarray(s, s += u), p.subarray(m), y);
			}
			var b = e[s++];
			if (b) {
				...
				for (var I = [
					...
					if (1 == x) {
						...
						I[v] = {
							s: _.subarray(2, 3),
							n: _.subarray(0, 1),
							t: new Pi(_.buffer, 0, 1),
							b: 0
						};
					} else 2 == x ? (s = (i = Ri(e, s, 9 - (1 & v)))[0], I[v] = i[1]) : 3 == x && (t.t || Ci(0), I[v] = t.t[v]);
				}
				var P = t.t = I, B = P[0], U = P[1], A = P[2], S = e[c - 1];
				S || Ci(0);
				var M = (c << 3) - 8 + Oi(S) - A.b, E = M >> 3, C = 0, T = (e[E] | e[E + 1] << 8) >> (7 & M) & (1 << A.b) - 1, z = (e[E = (M -= U.b) >> 3] | e[E + 1] << 8) >> (7 & M) & (1 << U.b) - 1, O = (e[E = (M -= B.b) >> 3] | e[E + 1] << 8) >> (7 & M) & (1 << B.b) - 1;
				for (++b; --b;) {
					var R = A.s[T], F = A.n[T], L = B.s[O], N = B.n[O], $ = U.s[z], D = U.n[z], W = 1 << $, K = W + ((e[E = (M -= $) >> 3] | e[E + 1] << 8 | e[E + 2] << 16 | e[E + 3] << 24) >>> (7 & M) & W - 1);
					E = (M -= Ki[L]) >> 3;
					var V = Vi[L] + ((e[E] | e[E + 1] << 8 | e[E + 2] << 16) >> (7 & M) & (1 << Ki[L]) - 1);
					E = (M -= Di[R]) >> 3;
					var H = Wi[R] + ((e[E] | e[E + 1] << 8 | e[E + 2] << 16) >> (7 & M) & (1 << Di[R]) - 1);
					if (E = (M -= F) >> 3, T = A.t[T] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << F) - 1), E = (M -= N) >> 3, O = B.t[O] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << N) - 1), E = (M -= D) >> 3, z = U.t[z] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << D) - 1), K > 3) t.o[2] = t.o[1], t.o[1] = t.o[0], t.o[0] = K -= 3;
						...
						var G = K - (0 != H);
						G ? (K = 3 == G ? t.o[0] - 1 : t.o[G], G > 1 && (t.o[2] = t.o[1]), t.o[1] = t.o[0], t.o[0] = K) : K = t.o[0];
					}
...
function ji(e, t) {
	for (var n = [], i = +!t, s = 0, r = 0; e.length;) {
		...
		if ("object" == typeof o) {
			for (i ? (t = null, o.w.length == o.u && (n.push(t = o.w), r += o.u)) : (n.push(t), o.e = 0); !o.l;) {
				var a = qi(e, o, t);
				a || Ci(5), t ? o.e = o.y : (n.push(a), r += a.length, Mi(o.w, 0, a.length), o.w.set(a, o.w.length - a.length));
			}
			s = o.b + 4 * o.c;
		} else s = o;
		e = e.subarray(s);
	...
	return function(e, t) {
		if (1 == e.length) return e[0];
		for (var n = new _i(t), i = 0, s = 0; i < e.length; ++i) {
			var r = e[i];
...
const Xi = 4096, Yi = 1024, Ji = Math.floor(160), Zi = 12, Qi = 16, es = 32, ts = 48, ns = 100, is = -2147483648, ss = {
...
var rs = class extends Error {
	code;
	constructor(e, t) {
		super(t || ss[e] || `Error ${e}`), this.code = e, this.name = "SFSError";
	}
};
const os = new TextEncoder(), as = new TextDecoder();
function cs(e) {
	return e.buffer instanceof SharedArrayBuffer ? as.decode(new Uint8Array(e)) : as.decode(e);
}
function ls(e) {
	return e + 3 & -4;
}
var hs = class e {
	...
	static mkfs(t, n) {
		...
		if (i < 65536) throw new rs(-22);
		const s = Math.floor(i / Xi), r = n ? Math.floor(n / Xi) : 4 * s;
		let o = Math.floor(r / 4);
		o < 32 && (o = 32), o = 32 * Math.ceil(o / 32);
		const a = Math.ceil(o / 32768), c = Math.ceil(r / 32768), l = Math.ceil(128 * o / Xi), h = 1 + a, d = h + c, f = d + l;
		if (f >= s) throw new rs(-28);
		new Uint8Array(t).fill(0);
		const u = new e(t);
		u.w32(0, 1397114451), u.w32(4, 1), u.w32(8, Xi), u.w32(12, s), u.w32(16, o), u.w32(28, 1), u.w32(32, h), u.w32(36, d), u.w32(40, f), u.w32(44, a), u.w32(48, c), u.w32(52, l), u.w32(68, r), u.w32(72, 256);
		const g = h * Xi;
		for (let e = 0; e < f; e++) {
			const t = (g >> 2) + (e >> 5);
			u.i32[t] |= 1 << (31 & e);
		...
		u.w32(m + 8, 16877), u.w32(m + Zi, 2);
		const y = u.blockAlloc();
		if (y < 0) throw new rs(-28);
		u.w32(m + ts, y);
		const w = y * Xi, b = ls(9), k = ls(10);
		u.w32(w, 1), u.view.setUint16(w + 4, b, !0), u.view.setUint16(w + 6, 1, !0), u.u8[w + 8] = 46;
		const I = w + b;
		return u.w32(I, 1), u.view.setUint16(I + 4, k, !0), u.view.setUint16(I + 6, 2, !0), u.u8[I + 8] = 46, u.u8[I + 8 + 1] = 46, u.w64(m + Qi, b + k), Atomics.store(u.i32, 14, 1), u;
	}
	static mount(t) {
		const n = new e(t);
		if (1397114451 !== n.r32(0)) throw new rs(-22, "Bad magic");
		if (1 !== n.r32(4)) throw new rs(-22, "Bad version");
		if (4096 !== n.r32(8)) throw new rs(-22, "Bad block size");
		return n;
	}
	statfs() {
	...
	blockAlloc() {
		const e = this.r32(12), t = this.r32(32) * Xi, n = Math.ceil(e / 32);
		for (let i = 0; i < n; i++) {
			...
			if (-1 !== s) for (let t = 0; t < 32; t++) {
				...
				if (Atomics.compareExchange(this.i32, n, s, o) === s) {
					...
					const e = r * Xi;
					return this.u8.fill(0, e, e + Xi), r;
				}
				i--;
				break;
			}
	...
	blockFree(e) {
		const t = (this.r32(32) * Xi >> 2) + (e >> 5), n = 31 & e;
		for (;;) {
	...
	inodeOffset(e) {
		return (this.r32(36) + Math.floor(e / 32)) * Xi + e % 32 * 128;
	}
	inodeAlloc() {
		const e = this.r32(16), t = this.r32(28) * Xi, n = Math.ceil(e / 32);
		for (let i = 0; i < n; i++) {
			const n = (t >> 2) + i, s = Atomics.load(this.i32, n);
			if (-1 !== s) for (let t = 0; t < 32; t++) {
				const r = 32 * i + t;
	...
	inodeFree(e) {
		const t = (this.r32(28) * Xi >> 2) + (e >> 5), n = 31 & e;
		for (;;) {
			const e = Atomics.load(this.i32, t), i = e & ~(1 << n);
			if (Atomics.compareExchange(this.i32, t, e, i) === e) break;
		}
	...
	inodeReadLock(e) {
		...
		for (;;) {
			...
			if (e & is) Atomics.wait(this.i32, t, e);
	...
	inodeWriteLock(e) {
		...
		for (;;) {
			const e = Atomics.load(this.i32, t);
			if (0 === e) {
				if (0 === Atomics.compareExchange(this.i32, t, 0, is)) return;
	...
	inodeBlockMap(e, t, n) {
		...
		if (t < 10) {
			const e = this.r32(i + ts + 4 * t);
			if (0 !== e) return e;
			if (!n) return 0;
			const s = this.blockAllocWithGrow();
			return s < 0 || this.w32(i + ts + 4 * t, s), s;
		}
		if ((t -= 10) < 1024) {
			let e = this.r32(i + 88);
			if (0 === e) {
		...
		if ((t -= Yi) < 1048576) {
			const e = Math.floor(t / Yi), s = t % Yi;
			let r = this.r32(i + 92);
			if (0 === r) {
				if (!n) return 0;
	...
	inodeReadData(e, t, n, i) {
		const s = this.inodeOffset(e), r = this.r64(s + Qi);
		if (t >= r) return 0;
		t + i > r && (i = r - t);
		let o = 0, a = 0;
		for (; i > 0;) {
			const s = Math.floor(t / Xi), r = t % Xi;
			let c = Xi - r;
			c > i && (c = i);
	...
	inodeWriteData(e, t, n, i) {
		...
		let r = 0, o = 0;
		for (; i > 0;) {
			const s = Math.floor(t / Xi), a = t % Xi;
			let c = Xi - a;
			c > i && (c = i);
		...
		return t > this.r64(s + Qi) && this.w64(s + Qi, t), r;
	}
	freeBlocksFrom(e, t) {
		const n = this.inodeOffset(e);
		for (let r = t; r < 10; r++) {
			const e = this.r32(n + ts + 4 * r);
			e && (this.blockFree(e), this.w32(n + ts + 4 * r, 0));
		}
		const i = this.r32(n + 88);
		if (i) {
			const e = t > 10 ? t - 10 : 0;
			for (let t = e; t < Yi; t++) {
				const e = i * Xi + 4 * t, n = this.r32(e);
		...
		if (s) {
			const e = t > 1034 ? t - 10 - Yi : 0, i = Math.floor(e / Yi);
			for (let t = i; t < Yi; t++) {
				const n = s * Xi + 4 * t, r = this.r32(n);
				if (!r) continue;
				const o = t === i ? e % Yi : 0;
				for (let e = o; e < Yi; e++) {
					const t = r * Xi + 4 * e, n = this.r32(t);
	...
	inodeTruncate(e, t) {
		const n = this.inodeOffset(e);
		if (t >= this.r64(n + Qi)) return void this.w64(n + Qi, t);
		const i = Math.ceil(t / Xi);
		this.freeBlocksFrom(e, i), this.w64(n + Qi, t);
	}
	dirLookup(e, t) {
		const n = this.inodeOffset(e), i = this.r64(n + Qi);
		let s = 0;
		for (; s < i;) {
			const n = Math.floor(s / Xi), r = s % Xi, o = this.inodeBlockMap(e, n, !1);
			if (o <= 0) return -5;
			const a = o * Xi;
			let c = i - s;
			c > 4096 - r && (c = Xi - r);
	...
	dirAddEntry(e, t, n) {
		const i = this.inodeOffset(e), s = this.r64(i + Qi), r = ls(8 + t.length);
		let o = -1, a = 0;
		for (; a < s;) {
			const i = Math.floor(a / Xi), c = a % Xi, l = this.inodeBlockMap(e, i, !1);
			if (l <= 0) return -5;
			const h = l * Xi;
			let d = s - a;
			d > 4096 - c && (d = Xi - c);
		...
		let c, l = s, h = Math.floor(l / Xi), d = l % Xi;
		if (0 !== d && d + r > 4096) {
			const t = Xi - d;
			if (t >= 8) {
		...
		const f = c * Xi + d;
		return this.w32(f, n), this.view.setUint16(f + 4, r, !0), this.view.setUint16(f + 6, t.length, !0), this.u8.set(t, f + 8), this.w64(i + Qi, l + r), 0;
	}
	dirRemoveEntry(e, t) {
		const n = this.inodeOffset(e), i = this.r64(n + Qi);
		let s = 0;
	...
	dirIsEmpty(e) {
		const t = this.inodeOffset(e), n = this.r64(t + Qi);
		let i = 0;
		for (; i < n;) {
			const t = Math.floor(i / Xi), s = i % Xi, r = this.inodeBlockMap(e, t, !1);
			if (r <= 0) return !0;
			const o = r * Xi;
			let a = n - i;
			a > 4096 - s && (a = Xi - s);
	...
	pathResolve(e, t) {
		...
		for (let r = 0; r < i.length; r++) {
			...
			const a = os.encode(e), c = this.dirLookup(n, a);
			if (c < 0) return c;
			const l = this.inodeOffset(c);
			if (40960 == (61440 & this.r32(l + 8)) && (r !== i.length - 1 || t)) {
				if (++s > 8) return -40;
				const e = this.r64(l + Qi);
				let t;
				if (e <= 40) t = cs(this.u8.subarray(l + ts, l + ts + e));
				else {
					const n = new Uint8Array(e);
					this.inodeReadData(c, 0, n, e), t = as.decode(n);
				}
				if (t.startsWith("/")) {
					n = 1;
	...
	pathResolveParent(e) {
		...
		if (16384 != (61440 & this.r32(r + 8))) throw new rs(-20);
		return {
			parentIno: s,
			name: n
		};
	...
	open(e, t, n = 420) {
		...
		if (r < 0 && -2 === r && s) {
			...
			try {
				const e = os.encode(i), s = this.dirLookup(t, e);
				if (s >= 0) r = s;
				else {
					const i = this.inodeAlloc();
					if (i < 0) throw new rs(-28);
					const s = this.inodeOffset(i);
					this.w32(s + 8, 32768 | 4095 & n), this.w32(s + Zi, 1), this.w64(s + Qi, 0);
					const o = Date.now();
					this.w64(s + 40, o), this.w64(s + 24, o), this.w64(s + es, o);
					const a = this.dirAddEntry(t, e, i);
					if (a < 0) throw this.inodeFree(i), new rs(a);
					r = i;
				}
			} finally {
		...
		if (16384 == (61440 & a) && 0 !== i) throw new rs(-21);
		if (65536 & t && 16384 != (61440 & a)) throw new rs(-20);
		if (512 & t) {
			if (16384 == (61440 & a)) throw new rs(-21);
			this.inodeWriteLock(r), this.inodeTruncate(r, 0), this.inodeWriteUnlock(r);
		}
		const c = this.fdAlloc(r, t, !1);
		if (c < 0) throw new rs(c);
		if (1024 & t) {
			const e = 256 + 24 * c;
			this.w64(e + 8, this.r64(o + Qi));
		}
		return c;
	}
	close(e) {
		if (!this.fdGet(e)) throw new rs(-9);
		this.fdFree(e);
	}
	read(e, t) {
	...
	unlink(e) {
		const { parentIno: t, name: n } = this.pathResolveParent(e), i = os.encode(n);
		this.inodeWriteLock(t);
		try {
			const e = this.dirLookup(t, i);
			if (e < 0) throw new rs(e);
			const n = this.inodeOffset(e);
			if (16384 == (61440 & this.r32(n + 8))) throw new rs(-21);
			const s = this.dirRemoveEntry(t, i);
			if (s < 0) throw new rs(s);
			this.inodeWriteLock(e);
			const r = this.r32(n + Zi);
			r <= 1 ? (this.inodeTruncate(e, 0), this.w32(n + Zi, 0), this.inodeWriteUnlock(e), this.inodeFree(e)) : (this.w32(n + Zi, r - 1), this.inodeWriteUnlock(e));
		} finally {
			this.inodeWriteUnlock(t);
		}
	}
	rename(e, t) {
		const { parentIno: n, name: i } = this.pathResolveParent(e), { parentIno: s, name: r } = this.pathResolveParent(t), o = os.encode(i), a = os.encode(r), c = Math.min(n, s), l = Math.max(n, s);
		...
		try {
			...
			if (t >= 0) {
				...
				if (16384 == (61440 & this.r32(e + 8))) throw new rs(-21);
				this.dirRemoveEntry(s, a), this.inodeWriteLock(t), this.inodeTruncate(t, 0), this.w32(e + Zi, 0), this.inodeWriteUnlock(t), this.inodeFree(t);
			}
			...
			if (16384 == (61440 & this.r32(r + 8)) && n !== s) {
				...
				this.w32(e + Zi, this.r32(e + Zi) - 1);
				const t = this.inodeOffset(s);
				this.w32(t + Zi, this.r32(t + Zi) + 1);
			}
		} finally {
	...
	mkdir(e, t = 493) {
		const { parentIno: n, name: i } = this.pathResolveParent(e), s = os.encode(i);
		this.inodeWriteLock(n);
		try {
			if (this.dirLookup(n, s) >= 0) throw new rs(-17);
			const e = this.inodeAlloc();
			if (e < 0) throw new rs(-28);
			const i = this.inodeOffset(e);
			this.w32(i + 8, 16384 | t), this.w32(i + Zi, 2), this.w64(i + Qi, 0);
			const r = Date.now();
			this.w64(i + 40, r), this.w64(i + 24, r), this.w64(i + es, r);
			const o = this.blockAllocWithGrow();
			if (o < 0) throw this.inodeFree(e), new rs(-28);
			this.w32(i + ts, o);
			const a = o * Xi, c = ls(9), l = ls(10);
			this.w32(a, e), this.view.setUint16(a + 4, c, !0), this.view.setUint16(a + 6, 1, !0), this.u8[a + 8] = 46;
			const h = a + c;
			this.w32(h, n), this.view.setUint16(h + 4, l, !0), this.view.setUint16(h + 6, 2, !0), this.u8[h + 8] = 46, this.u8[h + 8 + 1] = 46, this.w64(i + Qi, c + l);
			const d = this.dirAddEntry(n, s, e);
			if (d < 0) throw this.blockFree(o), this.inodeFree(e), new rs(d);
			const f = this.inodeOffset(n);
			this.w32(f + Zi, this.r32(f + Zi) + 1);
		} finally {
	...
	rmdir(e) {
		...
		try {
			...
			try {
				...
				this.dirRemoveEntry(t, i), this.inodeTruncate(e, 0), this.w32(n + Zi, 0);
			} finally {
				this.inodeWriteUnlock(e);
			}
			this.inodeFree(e);
			const s = this.inodeOffset(t);
			this.w32(s + Zi, this.r32(s + Zi) - 1);
		} finally {
			this.inodeWriteUnlock(t);
		}
	}
	symlink(e, t) {
		const { parentIno: n, name: i } = this.pathResolveParent(t), s = os.encode(i), r = os.encode(e);
		this.inodeWriteLock(n);
		try {
			if (this.dirLookup(n, s) >= 0) throw new rs(-17);
			const e = this.inodeAlloc();
			if (e < 0) throw new rs(-28);
			const t = this.inodeOffset(e);
			if (this.w32(t + 8, 41471), this.w32(t + Zi, 1), r.length <= 40) this.u8.set(r, t + ts), this.w64(t + Qi, r.length);
			else {
				this.w64(t + Qi, 0);
				const n = this.inodeWriteData(e, 0, r, r.length);
				if (n < 0) throw this.inodeFree(e), new rs(n);
			}
			const i = this.dirAddEntry(n, s, e);
			if (i < 0) throw this.inodeFree(e), new rs(i);
		} finally {
			this.inodeWriteUnlock(n);
		}
	}
	chmod(e, t) {
		...
		try {
			...
			this.w32(e + 8, 61440 & i | 4095 & t), this.w64(e + es, Date.now());
		} finally {
			this.inodeWriteUnlock(n);
		}
	}
	...
	chown(e, t, n) {
		...
		try {
			...
			this.w32(e + 96, t), this.w32(e + ns, n), this.w64(e + es, Date.now());
		} finally {
	...
	link(e, t) {
		...
		if (16384 == (61440 & this.r32(i + 8))) throw new rs(-1);
		const { parentIno: s, name: r } = this.pathResolveParent(t), o = os.encode(r);
		this.inodeWriteLock(s);
		try {
			if (this.dirLookup(s, o) >= 0) throw new rs(-17);
			const e = this.dirAddEntry(s, o, n);
			if (e < 0) throw new rs(e);
			this.inodeWriteLock(n);
			try {
				const e = this.r32(i + Zi);
				this.w32(i + Zi, e + 1), this.w64(i + es, Date.now());
			} finally {
				this.inodeWriteUnlock(n);
			}
		} finally {
	...
	readlink(e) {
		...
		const i = this.r64(n + Qi);
		if (i <= 40) return cs(this.u8.subarray(n + ts, n + ts + i));
		this.inodeReadLock(t);
		try {
			const e = new Uint8Array(i);
			return this.inodeReadData(t, 0, e, i), as.decode(e);
		} finally {
			this.inodeReadUnlock(t);
		}
	}
	...
	readdirEntry(e) {
		...
		const n = this.inodeOffset(t.ino), i = this.r64(n + Qi);
		for (; t.offset < i;) {
			const n = t.offset, i = Math.floor(n / Xi), s = n % Xi, r = this.inodeBlockMap(t.ino, i, !1);
			if (r <= 0) return null;
			const o = r * Xi + s, a = this.r32(o), c = this.view.getUint16(o + 4, !0), l = this.view.getUint16(o + 6, !0);
			if (0 === c) return null;
			t.offset = n + c;
			const h = 256 + 24 * e;
			if (this.w64(h + 8, n + c), 0 !== a) return {
				name: cs(this.u8.subarray(o + 8, o + 8 + l)),
	...
	writeFile(e, t) {
		const n = "string" == typeof t ? os.encode(t) : t, i = this.open(e, 577);
		try {
			this.write(i, n);
		} finally {
			this.close(i);
	...
	readFileText(e) {
		return as.decode(this.readFile(e));
	}
};
const ds = [
	40,
...
function ms(e) {
	return e.byteLength >= ds.length && e[0] === ds[0] && e[1] === ds[1] && e[2] === ds[2] && e[3] === ds[3] ? function(e) {
		return ji(e);
	}(e) : e;
}
function ys(e) {
	const t = ms(e);
	if (t.byteLength < us) throw new Error("VFS image too small");
	const n = new DataView(t.buffer, t.byteOffset, t.byteLength), i = n.getUint32(0, !0);
	if (i !== fs) throw new Error(`Bad VFS image magic: 0x${i.toString(16)} (expected 0x${fs.toString(16)})`);
	...
	if (t.byteLength < us + o + 4) throw new Error("VFS image truncated");
	return {
		image: t,
		view: n,
		flags: r,
...
var ws = class e {
	...
	static create(t, n) {
		return new e(hs.mkfs(t, n));
	}
	static fromExisting(t) {
		return new e(hs.mount(t));
	}
	...
	setImageMetadata(e) {
		this.imageMetadata = null === e ? null : ps(e);
	}
	...
	async saveImage(e) {
		...
		const t = new Uint8Array(this.fs.buffer), n = this.exportLazyEntries(), i = n.length > 0, s = i ? new TextEncoder().encode(JSON.stringify(n)) : new Uint8Array(0), r = this.exportLazyArchiveEntries(), o = r.length > 0, a = o ? new TextEncoder().encode(JSON.stringify(r)) : new Uint8Array(0), c = function(e) {
			...
			const t = ps(e), n = new TextEncoder().encode(JSON.stringify(t));
			if (n.byteLength > gs) throw new Error("VFS image metadata exceeds 65536 bytes");
			return n;
		}(void 0 === e?.metadata ? this.imageMetadata : e.metadata), l = c.byteLength > 0, h = o ? 4 + a.byteLength : 0, d = l ? 4 + c.byteLength : 0, f = us + t.byteLength + 4 + s.byteLength + h + d, u = new Uint8Array(f), g = new DataView(u.buffer);
		g.setUint32(0, fs, !0), g.setUint32(4, 1, !0), g.setUint32(8, (i ? 1 : 0) | (o ? 2 : 0) | (l ? 4 : 0), !0), g.setUint32(12, t.byteLength, !0);
		const p = new Uint8Array(t.byteLength);
		p.set(t), u.set(p, us);
		const m = us + t.byteLength;
	...
	static readImageMetadata(e) {
		...
		const { metadataOffset: n } = function(e, t, n, i) {
			const s = us + i, r = t.getUint32(s, !0), o = s + 4 + r;
			let a = o;
			if (2 & n) {
		...
		if (i > gs) throw new Error("VFS image metadata exceeds 65536 bytes");
		if (t.image.byteLength < n + 4 + i) throw new Error("VFS image truncated (metadata payload)");
		return 0 === i ? null : function(e) {
			if (e.byteLength > gs) throw new Error("VFS image metadata exceeds 65536 bytes");
			let t;
			try {
	...
	static fromImage(t, n) {
		...
		new Uint8Array(c).set(t.subarray(us, us + o));
		let l = null;
		4 & r && (l = e.readImageMetadata(t));
		const h = new e(hs.mount(c), l), d = us + o, f = s.getUint32(d, !0);
		if (1 & r && f > 0) {
...
function vs(e, t, n = {}) {
	...
	for (const s of e) if ("image" === s.source) {
		const e = ws.fromImage(t, { maxByteLength: 1073741824 });
		Is(e), i.push({
			mountPoint: s.path,
			backend: e,
			readonly: s.readonly
		...
		const e = n.scratchSabBytes?.[s.path] ?? 16777216, t = new SharedArrayBuffer(e), r = ws.create(t);
...
const _s = 16384, Ps = new TextEncoder(), Bs = new TextDecoder();
let Us = null, As = !1;
function Ss(e) {
	self.postMessage(e);
}
...
async function Os(e, t, n) {
	...
	let o = "", a = "", c = !1;
	Ms(n.machine, `running ${n.programName}`);
	const l = function(e, t, n, i) {
		const s = new xs([
			{
				mountPoint: "/dev/shm",
				backend: ws.create(new SharedArrayBuffer(1048576))
			},
			{
				mountPoint: "/dev",
				backend: new vi()
	...
	}(e, t.rootfs, n.machine, n.address), h = new si("/kandelo/assets/worker-entry-browser-BhKbSama.js");
	let d, f;
	...
	g.usePolling = !1, g.relistenBatchSize = 8, g.setOutputCallbacks({
		onStdout: (e) => {
			const t = Bs.decode(e);
			o += t, Cs(n.machine, "stdout", t);
		},
		onStderr: (e) => {
			const t = Bs.decode(e);
			a += t, Cs(n.machine, "stderr", t);
		}
	...
	null !== y && g.setBrkBase(r, y), void 0 !== n.stdin && g.setStdinData(r, Ps.encode(n.stdin));
	const w = {
	...
	try {
		const e = await u;
		return clearTimeout(I), Ms(n.machine, 0 === e ? "passed" : `failed ${e}`), {
			exitCode: e,
			stdout: o,
			stderr: a
		};
...
async function Ls(e, t) {
	...
	Cs("runner", "system", `UDP alpha: ${Fs(n)}\nUDP beta: ${Fs(i)}`), Cs("beta", "stdin", "hello from beta over udp\n");
	const s = Os(e, t, {
		machine: "alpha",
		address: [
			10,
	...
	return Es("udp", c ? "passed" : "failed"), Ts("udp", "UDP datagram", c, c ? "alpha received beta's datagram through POSIX recv/read on a UDP socket." : `server=${o.exitCode}, client=${a.exitCode}`), c;
}
async function Ns(e, t) {
	...
	Cs("runner", "system", `TCP alpha: ${Fs(n)}\nTCP beta: ${Fs(i)}`), Cs("beta", "stdin", "hello from beta over tcp\n");
	const s = Os(e, t, {
		machine: "alpha",
		address: [
			10,
	...
	return Es("tcp", c ? "passed" : "failed"), Ts("tcp", "TCP stream", c, c ? "alpha accepted beta's TCP connection and received stream data." : `server=${o.exitCode}, client=${a.exitCode}`), c;
}
async function $s(e, t) {
	...
	const n = "hello from alpha via curl\n", i = [
		...
		`Content-Length: ${Ps.encode(n).length}`,
		"Connection: close",
		"",
		n
	].join("\r\n"), s = [
	...
	Cs("runner", "system", `HTTP alpha: ${Fs(s)}\nHTTP gamma: ${Fs(r)}`), Cs("runner", "system", `HTTP alpha stdin: generated ${Ps.encode(i).length} byte response\n`), Cs("alpha", "stdin", `${i.replaceAll("\r\n", "\n")}`);
	const o = Os(e, t, {
		machine: "alpha",
		address: [
			10,
	...
	return Es("curl", h ? "passed" : "failed"), Ts("curl", "curl over TCP", h, h ? "gamma fetched alpha's HTTP response through curl over the virtual TCP backend." : `server=${c.exitCode}, curl=${l.exitCode}`), h;
}
async function Ds() {
	if (!As) {
		As = !0, Ss({
		...
		try {
			const e = await async function() {
				return Us || (Us = Promise.all([
					zs("/kandelo/assets/kernel-hxG0xOrk.wasm"),
					zs("/kandelo/assets/rootfs-vybv6JPX.vfs"),
					zs("/kandelo/assets/nc-CGHkR-Fh.wasm"),
					zs("/kandelo/assets/curl-BT_Xh_vR.wasm")
				]).then(([e, t, n, i]) => ({
					kernel: e,
			...
			const t = new gi();
			Cs("runner", "system", "Virtual addresses: alpha=10.88.0.2 beta=10.88.0.3 gamma=10.88.0.4\n"), Ss({
				type: "done",
				ok: [
					await Ls(t, e),
					await Ns(t, e),
