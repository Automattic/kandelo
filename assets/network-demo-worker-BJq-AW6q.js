...
const v = 1024, x = 1025, _ = 1026, P = 1027, B = 1028, U = 1029, A = 1030, S = 1280, M = 1281, E = 1282, C = 1283, T = 1284, z = 1536, O = 1537, R = 1538, F = 1792, N = 1793, L = 1794, $ = 1795, D = 1796, W = 1797, K = 1798;
function V(e, t, n) {
...
function Nt(e, t, n = function() {
	...
	const i = function(e, t) {
		const n = Lt(e, "kernel_host_adapter_manifest_ptr"), i = Lt(e, "kernel_host_adapter_manifest_len"), s = $t(n(), "kernel_host_adapter_manifest_ptr"), r = $t(i(), "kernel_host_adapter_manifest_len");
...
var ri = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-v6U1ErHU.js").then((e) => a(e.default, 1));
	...
	formatSyscallEntry(e, t, n) {
		...
		switch (t) {
			...
			case Ne: return `[${s}${o}] openat(${n[0]}, "${this.readCString(e.memory, n[1])}", 0x${(n[2] >>> 0).toString(16)}, 0o${(n[3] >>> 0).toString(8)})`;
			...
			case Le: return `[${s}${o}] ioctl(${n[0]}, 0x${(n[1] >>> 0).toString(16)})`;
	...
	handleBlockingRetry(e, t, n) {
		...
		if (Zn.has(t) || Qn.has(t) || t === Nn || t === Ln || t === $n) {
		...
		if (2 == o) {
			...
			if (0 == h) p.set(e.subarray(s, s += f), m);
				...
				if (2 == h) {
					var w = function(e, t) {
						...
						if (r < 128) {
							var l = Ni(e, t + 1, 6), h = l[0], d = l[1], f = h << 3, u = e[t += r];
							u || zi(0);
			...
			if (b) {
				...
				for (var I = [
					...
					} else 2 == x ? (s = (i = Ni(e, s, 9 - (1 & v)))[0], I[v] = i[1]) : 3 == x && (t.t || zi(0), I[v] = t.t[v]);
				}
				...
				for (++b; --b;) {
					var R = A.s[T], F = A.n[T], N = B.s[O], L = B.n[O], $ = U.s[z], D = U.n[z], W = 1 << $, K = W + ((e[E = (M -= $) >> 3] | e[E + 1] << 8 | e[E + 2] << 16 | e[E + 3] << 24) >>> (7 & M) & W - 1);
					E = (M -= Hi[N]) >> 3;
					var V = qi[N] + ((e[E] | e[E + 1] << 8 | e[E + 2] << 16) >> (7 & M) & (1 << Hi[N]) - 1);
					E = (M -= Ki[R]) >> 3;
					var H = Vi[R] + ((e[E] | e[E + 1] << 8 | e[E + 2] << 16) >> (7 & M) & (1 << Ki[R]) - 1);
					if (E = (M -= F) >> 3, T = A.t[T] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << F) - 1), E = (M -= L) >> 3, O = B.t[O] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << L) - 1), E = (M -= D) >> 3, z = U.t[z] + ((e[E] | e[E + 1] << 8) >> (7 & M) & (1 << D) - 1), K > 3) t.o[2] = t.o[1], t.o[1] = t.o[0], t.o[0] = K -= 3;
					else {
						var q = K - (0 != H);
...
async function Fs(e, t, n) {
	...
	}(e, t.rootfs, n.machine, n.address), h = new oi("/kandelo/assets/worker-entry-browser-BhKbSama.js");
	let d, f;
...
async function $s(e, t) {
	...
	zs("runner", "system", `UDP alpha: ${Ls(n)}\nUDP beta: ${Ls(i)}`), zs("beta", "stdin", "hello from beta over udp\n");
	const s = Fs(e, t, {
		machine: "alpha",
		address: [
			10,
...
async function Ds(e, t) {
	...
	zs("runner", "system", `TCP alpha: ${Ls(n)}\nTCP beta: ${Ls(i)}`), zs("beta", "stdin", "hello from beta over tcp\n");
	const s = Fs(e, t, {
		machine: "alpha",
		address: [
			10,
...
async function Ws(e, t) {
	...
	zs("runner", "system", `HTTP alpha: ${Ls(s)}\nHTTP gamma: ${Ls(r)}`), zs("runner", "system", `HTTP alpha stdin: generated ${Us.encode(i).length} byte response\n`), zs("alpha", "stdin", `${i.replaceAll("\r\n", "\n")}`);
	const o = Fs(e, t, {
		machine: "alpha",
		address: [
			10,
		...
		try {
			const e = await async function() {
				return Ss || (Ss = Promise.all([
					...
					Rs("/kandelo/assets/rootfs-D5CIVcTS.vfs"),
