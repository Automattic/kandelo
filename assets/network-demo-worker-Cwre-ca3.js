...
}, g = 65536, m = 65608, y = 65560, w = 211, k = 212, b = 213, I = 500, v = 386, x = 1, _ = 2, P = 3, B = 4, S = 6, A = 10, M = 11, E = 12, U = 19, C = 22, z = 24, T = 25, O = 34, R = 35, $ = 41, N = 46, L = 47, F = 48, W = 53, D = 54, K = 55, V = 56, H = 60, q = 62, G = 63, j = 64, X = 65, Y = 68, J = 69, Z = 72, Q = 81, ee = 82, te = 90, ie = 92, ne = 93, se = 97, re = 102, oe = 103, ae = 109, ce = 124, he = 126, le = 137, de = 138, fe = 139, ue = 200, pe = 201, ge = 207, me = 239, ye = 240, we = 241, ke = 251, be = 252, Ie = 278, ve = 288, xe = 294, _e = 295, Pe = 296, Be = 333, Se = 334, Ae = 343, Me = 345, Ee = 346, Ue = 378, Ce = 379, ze = 384, Te = 387, Oe = 415, Re = {
	1: [{
		argIndex: 0,
		direction: "in",
		size: { type: "cstring" }
...
const tt = 67108864;
const it = 11, nt = $, st = Y, rt = ce, ot = ue, at = H, ct = ke, ht = be, lt = oe, dt = we, ft = me, ut = Ue, pt = ye, gt = Ce, mt = ge, yt = R, wt = w, kt = v, bt = k, It = b, vt = I, xt = pe, _t = O, Pt = Te, Bt = te, St = ie, At = fe, Mt = ve, Et = Oe, Ut = 16777216, Ct = Z, zt = N, Tt = L, Ot = F, Rt = he, $t = Ie, Nt = B, Lt = P, Ft = j, Wt = X, Dt = K, Kt = V, Vt = q, Ht = G, qt = le, Gt = de, jt = W, Xt = ze, Yt = D, Jt = Q, Zt = ee, Qt = _e, ei = Pe, ti = A, ii = Ae, ni = Me, si = Ee, ri = Be, oi = Se, ai = "undefined" != typeof process && !!{}.WASM_POSIX_PROFILE, ci = new Set([
	P,
	V,
	G,
	j,
...
var ui = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-BS6qb8JG.js").then((e) => a(e.default, 1));
	...
	formatSyscallEntry(e, t, i) {
		...
		switch (t) {
			...
			case L: return `[${s}${o}] munmap(0x${(i[0] >>> 0).toString(16)}, ${i[1] >>> 0})`;
	...
	_handleSyscallInner(e) {
		...
		if ((i === Nt || i === Wt) && n[2] > 65536) return void this.handleLargeWrite(e, i, n);
		if ((i === Lt || i === Ft) && n[2] > 65536) return void this.handleLargeRead(e, i, n);
		...
		if (null !== b && i === Ot && w > b && console.error(`[BRK ALERT] pid=${e.pid} brk returned 0x${(w >>> 0).toString(16)} — IN THREAD REGION!`), i === zt && w > 0 && w >>> 0 != 4294967295) {
			const t = n[4], i = n[3] >>> 0;
		...
		i === $t && 0 === w && this.flushSharedMappings(e, n), i === Tt && 0 === w && (this.flushSharedMappings(e, n), this.cleanupSharedMappings(e.pid, n[0] >>> 0, n[1] >>> 0));
	...
	pwriteFromProcessMemory(e, t, i, n, s) {
		...
		for (; h < n;) {
			...
			const f = s + h;
			o.setUint32(4, Wt, !0), o.setBigInt64(8, BigInt(t), !0), o.setBigInt64(16, BigInt(c), !0), o.setBigInt64(24, BigInt(l), !0), o.setBigInt64(32, BigInt(4294967295 & f), !0), o.setBigInt64(40, BigInt(0 | Math.floor(f / 4294967296)), !0), o.setBigInt64(48, BigInt(0), !0), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
			try {
...
var Ci = class {
	...
	s > i && Di(3);
	for (var r = 1 << s, o = r, a = -1, c = -1, h = -1, l = r, d = new zi(512 + (r << 2)), f = new Ri(d, 0, 256), u = new Oi(d, 0, 256), p = new Oi(d, 512, r), g = 512 + (r << 1), m = new Ti(d, g, r), y = new Ti(d, g + r); a < 255 && o > 0;) {
	...
	if (1 == o) {
		...
		return t.b = s + 1, i ? (Li(i, e[s], t.y, t.y += a), i) : Li(new Ti(a), e[s]);
	}
	if (!(c > e.length)) {
		...
		if (2 == o) {
			...
			if (0 == l) g.set(e.subarray(s, s += f), m);
				...
				if (2 == l) {
					var w = function(e, t) {
						...
						var B = new Ti(x << 1), S = B.subarray(0, x), A = B.subarray(x);
						for (c[v] = 0, i = v; i > 0; --i) {
							var M = c[i];
							Li(A, i, M, c[i - 1] = M + a[i] * (1 << v - i));
						}
						for (c[0] != x && Di(0), i = 0; i < n; ++i) {
							var E = o[i];
							if (E) {
								var U = c[E];
								Li(S, i, U, c[E] = U + (1 << v - E));
							}
						}
						return [t, {
							n: A,
			...
			if (k) {
				...
				M || Di(0);
				var E = (c << 3) - 8 + Hi(M) - A.b, U = E >> 3, C = 0, z = (e[U] | e[U + 1] << 8) >> (7 & E) & (1 << A.b) - 1, T = (e[U = (E -= S.b) >> 3] | e[U + 1] << 8) >> (7 & E) & (1 << S.b) - 1, O = (e[U = (E -= B.b) >> 3] | e[U + 1] << 8) >> (7 & E) & (1 << B.b) - 1;
				for (++k; --k;) {
					var R = A.s[z], $ = A.n[z], N = B.s[O], L = B.n[O], F = S.s[T], W = S.n[T], D = 1 << F, K = D + ((e[U = (E -= F) >> 3] | e[U + 1] << 8 | e[U + 2] << 16 | e[U + 3] << 24) >>> (7 & E) & D - 1);
					U = (E -= Qi[N]) >> 3;
					var V = en[N] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & E) & (1 << Qi[N]) - 1);
					U = (E -= Ji[R]) >> 3;
					var H = Zi[R] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & E) & (1 << Ji[R]) - 1);
					if (U = (E -= $) >> 3, z = A.t[z] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << $) - 1), U = (E -= L) >> 3, O = B.t[O] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << L) - 1), U = (E -= W) >> 3, T = S.t[T] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << W) - 1), K > 3) t.o[2] = t.o[1], t.o[1] = t.o[0], t.o[0] = K -= 3;
					else {
						var q = K - (0 != H);
...
var Mn = class e {
	...
	async fetchLazyBytes(e) {
		let t = 0, i = e.fallbackTotalBytes;
		const n = {
			id: e.id,
			kind: e.kind,
			url: e.url,
		...
		try {
			...
			const a = function(e, t) {
				...
				const i = new Uint8Array(t);
				let n = 0;
				for (const s of e) i.set(s, n), n += s.byteLength;
				return i;
			}(o, t);
	...
	async ensureMaterialized(e) {
		...
		try {
			...
			if (i) {
				...
				}), n = this.fs.open(i.path, 577, 493);
				return this.fs.write(n, e), this.fs.close(n), this.lazyFiles.delete(t.ino), !0;
			}
	...
	async ensureArchiveMaterialized(e) {
		...
		const t = await this.fetchLazyBytes({
			...
			url: e.url,
			mountPrefix: e.mountPrefix
		}), { parseZipCentralDirectory: i, extractZipEntry: n } = await import("./zip-D1JNL24E.js"), s = i(t), r = /* @__PURE__ */ new Map();
		for (const a of s) r.set(a.fileName, a);
		const o = e.mountPrefix.replace(/\/+$/, "");
		for (const [a, c] of e.entries) {
			if (c.deleted) continue;
			if (c.isSymlink) continue;
			const e = a.slice(o.length + 1), i = r.get(e);
			if (!i) continue;
			const s = n(t, i), h = this.fs.open(a, 577, 493);
			s.length > 0 && this.fs.write(h, s), this.fs.close(h);
		}
		e.materialized = !0;
...
async function qn(e, t, i) {
	...
	let o = "", a = "", c = !1;
	Wn(i.machine, `running ${i.programName}`);
	...
	try {
		const e = await u;
		return clearTimeout(I), Wn(i.machine, 0 === e ? "passed" : `failed ${e}`), {
			exitCode: e,
			stdout: o,
			stderr: a
		};
		...
		try {
			const e = await async function() {
				return Nn || (Nn = Promise.all([
					...
					Hn("/kandelo/assets/rootfs-BTrUif3t.vfs"),
