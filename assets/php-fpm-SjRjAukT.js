...
`;function s(e,t){const o="/var/www/html";i(e,"/etc/php-fpm.d"),i(e,"/var/log"),i(e,"/tmp/nginx_fastcgi_temp"),n(e,"/etc/php-fpm.conf",r(t));const p=o.replace(/\/[^/]*$/,"");i(e,p),n(e,p+"/fpm-router.php",l)}const f="/wasm-posix-kernel/assets/php-fpm-CG1D0-hZ.wasm";export{s as a,f as p};
