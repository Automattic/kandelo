...
var ii = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-DD1SsTNW.js").then((e) => a(e.default, 1));
		...
		try {
			const e = await async function() {
				return Us || (Us = Promise.all([
					...
					zs("/kandelo/assets/rootfs-BnXGH66v.vfs"),
					zs("/kandelo/assets/nc-CGHkR-Fh.wasm"),
					zs("/kandelo/assets/curl-D6_BEfxc.wasm")
				]).then(([e, t, n, i]) => ({
					kernel: e,
