import{B as _,k as g}from"./browser-kernel-CJ1uzMhJ.js";/* empty css               */const S="/wasm-posix-kernel/assets/php-CUZZnCmB.wasm",m=document.getElementById("code"),r=document.getElementById("output"),u=document.getElementById("run"),l=document.getElementById("examples"),o=document.getElementById("status"),f=new TextDecoder,T=new TextEncoder;function s(e,n){const t=document.createElement("span");n&&(t.className=n),t.textContent=e,r.appendChild(t),r.scrollTop=r.scrollHeight}function d(e,n){o.style.display="block",o.textContent=e,o.className=`status ${n}`}function w(){o.style.display="none"}const E={hello:`<?php
