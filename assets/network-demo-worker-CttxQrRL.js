...
var ri = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-CctK44Pf.js").then((e) => a(e.default, 1));
		...
		try {
			const e = await async function() {
				return Ss || (Ss = Promise.all([
					Rs("/kandelo/assets/kernel-BlRINXWS.wasm"),
					Rs("/kandelo/assets/rootfs-D0wLXhle.vfs"),
					Rs("/kandelo/assets/nc-BmT7hcgk.wasm"),
					Rs("/kandelo/assets/curl-CeeFASWM.wasm")
				]).then(([e, t, n, i]) => ({
					kernel: e,
