...
var ii = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-N9K8wOmU.js").then((e) => a(e.default, 1));
		...
		try {
			const e = await async function() {
				return Us || (Us = Promise.all([
					...
					zs("/kandelo/assets/rootfs-Cxg8Cfpd.vfs"),
					zs("/kandelo/assets/nc-CGHkR-Fh.wasm"),
					zs("/kandelo/assets/curl-B_Gdquc_.wasm")
				]).then(([e, t, n, i]) => ({
					kernel: e,
