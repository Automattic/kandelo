...
}, g = 65536, m = 65608, w = 65560, y = 211, k = 212, b = 213, I = 500, v = 386, x = 1, _ = 2, P = 3, B = 4, S = 6, A = 10, E = 11, M = 12, U = 19, C = 22, z = 24, T = 25, O = 34, R = 35, $ = 41, N = 46, W = 47, F = 48, L = 53, D = 54, K = 55, V = 56, H = 60, q = 62, G = 63, j = 64, X = 65, Y = 68, J = 69, Z = 72, Q = 81, ee = 82, te = 90, ie = 92, ne = 93, se = 97, re = 102, oe = 103, ae = 109, ce = 124, he = 126, le = 137, de = 138, fe = 139, ue = 200, pe = 201, ge = 207, me = 239, we = 240, ye = 241, ke = 251, be = 252, Ie = 278, ve = 288, xe = 294, _e = 295, Pe = 296, Be = 333, Se = 334, Ae = 343, Ee = 345, Me = 346, Ue = 378, Ce = 379, ze = 384, Te = 387, Oe = 415, Re = {
	1: [{
		argIndex: 0,
		direction: "in",
		size: { type: "cstring" }
	...
	hostFcntlLock(t, i, n, s, r, o, a, c, l, d) {
		...
		try {
			...
			switch (s) {
				...
				case e.F_SETLK: return this.sharedLockTable.setLock(p, n, r, g, m) ? 0 : -11;
				case e.F_SETLKW: return this.sharedLockTable.setLockWait(p, n, r, g, m), 0;
				default: return -22;
			}
		} catch {
			return -5;
...
function Xe(e, t, i = function() {
	...
	if (14 !== n.abiVersion) throw new Error(`kernel host adapter manifest ABI version ${n.abiVersion} does not match host ABI version 14`);
...
const tt = 67108864;
const it = 11, nt = $, st = Y, rt = ce, ot = ue, at = H, ct = ke, ht = be, lt = oe, dt = ye, ft = me, ut = Ue, pt = we, gt = Ce, mt = ge, wt = R, yt = y, kt = v, bt = k, It = b, vt = I, xt = pe, _t = O, Pt = Te, Bt = te, St = ie, At = fe, Et = ve, Mt = Oe, Ut = 16777216, Ct = Z, zt = N, Tt = W, Ot = F, Rt = he, $t = Ie, Nt = B, Wt = P, Ft = j, Lt = X, Dt = K, Kt = V, Vt = q, Ht = G, qt = le, Gt = de, jt = L, Xt = ze, Yt = D, Jt = Q, Zt = ee, Qt = _e, ei = Pe, ti = A, ii = Ae, ni = Ee, si = Me, ri = Be, oi = Se, ai = "undefined" != typeof process && !!{}.WASM_POSIX_PROFILE, ci = new Set([
	P,
	V,
	G,
	j,
...
var ui = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-CQ-pCGVU.js").then((e) => a(e.default, 1));
	...
	_handleSyscallInner(e) {
		...
		if (I && I(e.pid) >= 128) this.handleProcessTerminated(e);
			...
			this.handleSleepDelay(e, i, n, y, k) || (0 !== k || i !== Bt && i !== St || this.recheckDeferredWaitpids(), 0 === k && i === wt && (this.scheduleWakeBlockedRetries(), this.reapKilledProcessesAfterSyscall()), c && console.error(h + this.formatSyscallReturn(i, y, k)), this.completeChannel(e, i, n, f, y, k));
		}
	}
	...
	handleFcntlLock(e, t) {
		...
		for (let l = 3; l < 6; l++) r.setBigInt64(8 + 8 * l, BigInt(t[l]), !0);
		...
		0 !== i && c >= 0 && new Uint8Array(e.memory.buffer).set(s.subarray(o, o + 32), i), this.completeChannel(e, ti, t, void 0, c, h);
	}
	handleSelect(e, t) {
	...
	handleRecvmsg(e, t) {
		...
		const S = y.getUint32(w + 4, !0), A = y.getUint32(w + 20, !0), E = y.getUint32(w + 24, !0);
		8 === l ? (o.setUint32(n + 8, S, !0), o.setUint32(n + 40, A, !0), o.setUint32(n + 44, E, !0)) : (o.setUint32(n + 4, S, !0), o.setUint32(n + 20, A, !0), o.setUint32(n + 24, E, !0)), this.completeChannel(e, Gt, t, void 0, P, B);
	}
	handleFork(e, t) {
...
var Ci = class {
	...
	(a > 255 || o) && Di(0);
	for (var B = 0, S = (r >> 1) + (r >> 3) + 3, A = r - 1, E = 0; E <= a; ++E) {
		var M = f[E];
		if (M < 1) u[E] = -M;
		else for (h = 0; h < M; ++h) {
			m[B] = E;
	...
	if (!(c > e.length)) {
		...
		if (2 == o) {
			...
			if (0 == l) g.set(e.subarray(s, s += f), m);
				...
				if (2 == l) {
					var y = function(e, t) {
						...
						for (c[v] = 0, i = v; i > 0; --i) {
							var E = c[i];
							Wi(A, i, E, c[i - 1] = E + a[i] * (1 << v - i));
						}
						for (c[0] != x && Di(0), i = 0; i < n; ++i) {
							var M = o[i];
							if (M) {
								var U = c[M];
								Wi(S, i, U, c[M] = U + (1 << v - M));
							}
						}
						return [t, {
							n: A,
			...
			if (k) {
				...
				var P = t.t = I, B = P[0], S = P[1], A = P[2], E = e[c - 1];
				E || Di(0);
				var M = (c << 3) - 8 + Hi(E) - A.b, U = M >> 3, C = 0, z = (e[U] | e[U + 1] << 8) >> (7 & M) & (1 << A.b) - 1, T = (e[U = (M -= S.b) >> 3] | e[U + 1] << 8) >> (7 & M) & (1 << S.b) - 1, O = (e[U = (M -= B.b) >> 3] | e[U + 1] << 8) >> (7 & M) & (1 << B.b) - 1;
				for (++k; --k;) {
					var R = A.s[z], $ = A.n[z], N = B.s[O], W = B.n[O], F = S.s[T], L = S.n[T], D = 1 << F, K = D + ((e[U = (M -= F) >> 3] | e[U + 1] << 8 | e[U + 2] << 16 | e[U + 3] << 24) >>> (7 & M) & D - 1);
					U = (M -= Qi[N]) >> 3;
					var V = en[N] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & M) & (1 << Qi[N]) - 1);
					U = (M -= Ji[R]) >> 3;
					var H = Zi[R] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & M) & (1 << Ji[R]) - 1);
					if (U = (M -= $) >> 3, z = A.t[z] + ((e[U] | e[U + 1] << 8) >> (7 & M) & (1 << $) - 1), U = (M -= W) >> 3, O = B.t[O] + ((e[U] | e[U + 1] << 8) >> (7 & M) & (1 << W) - 1), U = (M -= L) >> 3, T = S.t[T] + ((e[U] | e[U + 1] << 8) >> (7 & M) & (1 << L) - 1), K > 3) t.o[2] = t.o[1], t.o[1] = t.o[0], t.o[0] = K -= 3;
					else {
						var q = K - (0 != H);
...
const on = 4096, an = 1024, cn = 12, hn = 16, ln = 32, dn = 48, fn = 100, un = 24, pn = -2147483648, gn = {
...
var In = class e {
	...
	static mkfs(t, i) {
		...
		const I = y + k;
		return u.w32(I, 1), u.view.setUint16(I + 4, b, !0), u.view.setUint16(I + 6, 2, !0), u.u8[I + 8] = 46, u.u8[I + 8 + 1] = 46, u.w64(m + hn, k + b), Atomics.store(u.i32, 14, 1), u;
	}
	static mount(t) {
		const i = new e(t);
	...
	statfs() {
		return {
			blockSize: this.r32(8),
			totalBlocks: this.r32(12),
			freeBlocks: Atomics.load(this.i32, 5),
	...
	inodeBlockMap(e, t, i) {
		...
		if (t < 10) {
			const e = this.r32(n + dn + 4 * t);
			if (0 !== e) return e;
			if (!i) return 0;
			const s = this.blockAllocWithGrow();
			return s < 0 || this.w32(n + dn + 4 * t, s), s;
		}
		if ((t -= 10) < 1024) {
			let e = this.r32(n + 88);
			if (0 === e) {
	...
	inodeReadData(e, t, i, n) {
		const s = this.inodeOffset(e), r = this.r64(s + hn);
		if (t >= r) return 0;
		t + n > r && (n = r - t);
		let o = 0, a = 0;
		for (; n > 0;) {
	...
	inodeWriteData(e, t, i, n) {
		...
		return t > this.r64(s + hn) && this.w64(s + hn, t), r;
	}
	freeBlocksFrom(e, t) {
		const i = this.inodeOffset(e);
		for (let r = t; r < 10; r++) {
			const e = this.r32(i + dn + 4 * r);
			e && (this.blockFree(e), this.w32(i + dn + 4 * r, 0));
		}
	...
	inodeTruncate(e, t) {
		const i = this.inodeOffset(e);
		if (t >= this.r64(i + hn)) return void this.w64(i + hn, t);
		const n = Math.ceil(t / on);
		this.freeBlocksFrom(e, n), this.w64(i + hn, t);
	}
	dirLookup(e, t) {
		const i = this.inodeOffset(e), n = this.r64(i + hn);
		let s = 0;
		for (; s < n;) {
	...
	dirAddEntry(e, t, i) {
		const n = this.inodeOffset(e), s = this.r64(n + hn), r = bn(8 + t.length);
		let o = -1, a = 0;
		for (; a < s;) {
		...
		const f = c * on + d;
		return this.w32(f, i), this.view.setUint16(f + 4, r, !0), this.view.setUint16(f + 6, t.length, !0), this.u8.set(t, f + 8), this.w64(n + hn, h + r), 0;
	}
	dirRemoveEntry(e, t) {
		const i = this.inodeOffset(e), n = this.r64(i + hn);
		let s = 0;
	...
	dirIsEmpty(e) {
		const t = this.inodeOffset(e), i = this.r64(t + hn);
		let n = 0;
		for (; n < i;) {
	...
	pathResolve(e, t) {
		...
		for (let r = 0; r < n.length; r++) {
			...
			if (40960 == (61440 & this.r32(h + 8)) && (r !== n.length - 1 || t)) {
				if (++s > 8) return -40;
				const e = this.r64(h + hn);
				let t;
				if (e <= 40) t = kn(this.u8.subarray(h + dn, h + dn + e));
				else {
		...
		if (r < 0 && -2 === r && s) {
			...
			try {
				...
				if (s >= 0) r = s;
					...
					this.w32(s + 8, 32768 | 4095 & i), this.w32(s + cn, 1), this.w64(s + hn, 0);
					const o = Date.now();
					this.w64(s + 40, o), this.w64(s + 24, o), this.w64(s + ln, o);
	...
	read(e, t) {
		...
		try {
			const n = this.inodeReadData(i.ino, i.offset, t, t.length), s = 256 + e * un;
	...
	write(e, t) {
		...
		try {
			...
			const s = this.inodeWriteData(i.ino, n, t, t.length), r = 256 + e * un;
	...
	unlink(e) {
		...
		try {
			...
			const r = this.r32(i + cn);
			r <= 1 ? (this.inodeTruncate(e, 0), this.w32(i + cn, 0), this.inodeWriteUnlock(e), this.inodeFree(e)) : (this.w32(i + cn, r - 1), this.inodeWriteUnlock(e));
		} finally {
			this.inodeWriteUnlock(t);
		}
	}
	rename(e, t) {
		...
		try {
			...
			if (t >= 0) {
				...
				this.dirRemoveEntry(s, a), this.inodeWriteLock(t), this.inodeTruncate(t, 0), this.w32(e + cn, 0), this.inodeWriteUnlock(t), this.inodeFree(t);
			}
			...
			if (16384 == (61440 & this.r32(r + 8)) && i !== s) {
				...
				this.w32(e + cn, this.r32(e + cn) - 1);
				const t = this.inodeOffset(s);
				this.w32(t + cn, this.r32(t + cn) + 1);
			}
		} finally {
	...
	mkdir(e, t = 493) {
		...
		try {
			...
			const n = this.inodeOffset(e);
			this.w32(n + 8, 16384 | t), this.w32(n + cn, 2), this.w64(n + hn, 0);
			const r = Date.now();
			this.w64(n + 40, r), this.w64(n + 24, r), this.w64(n + ln, r);
			const o = this.blockAllocWithGrow();
			...
			const l = a + c;
			this.w32(l, i), this.view.setUint16(l + 4, h, !0), this.view.setUint16(l + 6, 2, !0), this.u8[l + 8] = 46, this.u8[l + 8 + 1] = 46, this.w64(n + hn, c + h);
			const d = this.dirAddEntry(i, s, e);
			if (d < 0) throw this.blockFree(o), this.inodeFree(e), new mn(d);
			const f = this.inodeOffset(i);
			this.w32(f + cn, this.r32(f + cn) + 1);
		} finally {
	...
	rmdir(e) {
		...
		try {
			...
			try {
				...
				this.dirRemoveEntry(t, n), this.inodeTruncate(e, 0), this.w32(i + cn, 0);
			} finally {
				this.inodeWriteUnlock(e);
			}
			this.inodeFree(e);
			const s = this.inodeOffset(t);
			this.w32(s + cn, this.r32(s + cn) - 1);
		} finally {
			this.inodeWriteUnlock(t);
		}
	}
	symlink(e, t) {
		...
		try {
			...
			if (e < 0) throw new mn(-28);
			const t = this.inodeOffset(e);
			if (this.w32(t + 8, 41471), this.w32(t + cn, 1), r.length <= 40) this.u8.set(r, t + dn), this.w64(t + hn, r.length);
			else {
				this.w64(t + hn, 0);
	...
	chmod(e, t) {
		...
		try {
			...
			this.w32(e + 8, 61440 & n | 4095 & t), this.w64(e + ln, Date.now());
		} finally {
			this.inodeWriteUnlock(i);
		}
	}
	...
	chown(e, t, i) {
		...
		try {
			...
			this.w32(e + 96, t), this.w32(e + fn, i), this.w64(e + ln, Date.now());
		} finally {
	...
	link(e, t) {
		...
		try {
			...
			this.inodeWriteLock(i);
			try {
				const e = this.r32(n + cn);
				this.w32(n + cn, e + 1), this.w64(n + ln, Date.now());
			} finally {
				this.inodeWriteUnlock(i);
			}
		} finally {
	...
	readlink(e) {
		...
		const n = this.r64(i + hn);
		if (n <= 40) return kn(this.u8.subarray(i + dn, i + dn + n));
		this.inodeReadLock(t);
		try {
	...
	readdirEntry(e) {
		...
		const i = this.inodeOffset(t.ino), n = this.r64(i + hn);
		for (; t.offset < n;) {
...
async function qn(e, t, i) {
	...
	}(e, t.rootfs, i.machine, i.address), l = new pi("/kandelo/assets/worker-entry-browser-BLl5r4T8.js");
	let d, f;
		...
		try {
			const e = await async function() {
				return Nn || (Nn = Promise.all([
					Hn("/kandelo/assets/kernel-C4M5S7_8.wasm"),
					Hn("/kandelo/assets/rootfs-BxLXY9lo.vfs"),
					Hn("/kandelo/assets/nc-Dv05dwnt.wasm"),
					Hn("/kandelo/assets/curl-CxfEfIg_.wasm")
				]).then(([e, t, i, n]) => ({
					kernel: e,
