...
}, g = 65536, m = 65608, y = 65560, w = 211, k = 212, b = 213, I = 500, v = 386, x = 1, _ = 2, P = 3, B = 4, S = 6, A = 10, M = 11, E = 12, U = 19, C = 22, T = 24, z = 25, O = 34, R = 35, $ = 41, N = 46, F = 47, W = 48, L = 53, D = 54, K = 55, V = 56, H = 60, q = 62, G = 63, j = 64, X = 65, Y = 68, J = 69, Z = 72, Q = 81, ee = 82, te = 90, ie = 92, ne = 93, se = 97, re = 102, oe = 103, ae = 109, ce = 124, he = 126, le = 137, de = 138, fe = 139, ue = 200, pe = 201, ge = 207, me = 239, ye = 240, we = 241, ke = 251, be = 252, Ie = 278, ve = 288, xe = 294, _e = 295, Pe = 296, Be = 333, Se = 334, Ae = 343, Me = 345, Ee = 346, Ue = 378, Ce = 379, Te = 384, ze = 387, Oe = 415, Re = {
	1: [{
		argIndex: 0,
		direction: "in",
		size: { type: "cstring" }
...
const tt = 67108864;
const it = 11, nt = $, st = Y, rt = ce, ot = ue, at = H, ct = ke, ht = be, lt = oe, dt = we, ft = me, ut = Ue, pt = ye, gt = Ce, mt = ge, yt = R, wt = w, kt = v, bt = k, It = b, vt = I, xt = pe, _t = O, Pt = ze, Bt = te, St = ie, At = fe, Mt = ve, Et = Oe, Ut = 16777216, Ct = Z, Tt = N, zt = F, Ot = W, Rt = he, $t = Ie, Nt = B, Ft = P, Wt = j, Lt = X, Dt = K, Kt = V, Vt = q, Ht = G, qt = le, Gt = de, jt = L, Xt = Te, Yt = D, Jt = Q, Zt = ee, Qt = _e, ei = Pe, ti = A, ii = Ae, ni = Me, si = Ee, ri = Be, oi = Se, ai = "undefined" != typeof process && !!{}.WASM_POSIX_PROFILE, ci = new Set([
	P,
	V,
	G,
	j,
...
var ui = class {
	...
	async init(e) {
		...
		try {
			const e = await import("./__vite-browser-external-B10XlTMB.js").then((e) => a(e.default, 1));
	...
	readBytesPreview(e, t, i, n = 160) {
		if (0 === t || i <= 0) return "";
		const s = new Uint8Array(e.buffer), r = Math.max(0, Math.min(i, n, s.length - t));
		if (r <= 0) return "";
	...
	formatSyscallEntry(e, t, i) {
		...
		switch (t) {
			...
			case M: return `[${s}${o}] stat("${this.readCString(e.memory, i[0])}")`;
			case E: return `[${s}${o}] lstat("${this.readCString(e.memory, i[0])}")`;
			...
			case T: return `[${s}${o}] chdir("${this.readCString(e.memory, i[0])}")`;
			case z: return `[${s}${o}] opendir("${this.readCString(e.memory, i[0])}")`;
			...
			case B: return `[${s}${o}] write(${i[0]}, ${i[2]}, ${JSON.stringify(this.readBytesPreview(e.memory, i[1], i[2]))})`;
			case _: return `[${s}${o}] close(${i[0]})`;
			case S: return `[${s}${o}] fstat(${i[0]})`;
			case A: return `[${s}${o}] fcntl(${i[0]}, ${i[1]}, ${i[2]})`;
			case N: return `[${s}${o}] mmap(0x${(i[0] >>> 0).toString(16)}, ${i[1] >>> 0}, ${i[2]}, 0x${(i[3] >>> 0).toString(16)}, ${i[4]}, ${i[5] >>> 0})`;
			case F: return `[${s}${o}] munmap(0x${(i[0] >>> 0).toString(16)}, ${i[1] >>> 0})`;
			case W: return `[${s}${o}] brk(0x${(i[0] >>> 0).toString(16)})`;
			case w: return `[${s}${o}] execve("${this.readCString(e.memory, i[0])}")`;
	...
	formatSyscallReturn(e, t, i) {
		...
		switch (e) {
			case N:
			case W: return ` = 0x${(t >>> 0).toString(16)}`;
			default: return ` = ${t}`;
		}
	}
	handleSyscall(e) {
	...
	_handleSyscallInner(e) {
		...
		r || (r = [], this.syscallRing.set(s, r)), r.push(`  ${this.formatSyscallEntry(e, i, n)}`), r.length > 30 && r.shift(), this.syscallTraceEnabled && (this.syscallTraceRing.length >= this.syscallTraceCap && this.syscallTraceRing.shift(), this.syscallTraceRing.push({
			t: performance.now(),
			pid: e.pid,
			nr: i,
			args: [
		...
		if (i === wt) return c && console.error(h), void this.handleExec(e, n);
		...
		if (i === At) return c && console.error(h), void this.handleWaitpid(e, n);
		if (i === Mt) return c && console.error(h), void this.handleWaitid(e, n);
		if (i === ot) {
			if (c) {
				const t = {
					0: "WAIT",
		...
		if (i === Et) return c && console.error(h), void this.handleThreadCancel(e, n);
		...
		if ((i === Ft || i === Wt) && n[2] > 65536) return void this.handleLargeRead(e, i, n);
		...
		const m = globalThis.__sysprof, y = m ? performance.now() : 0;
		if (m) {
			const t = globalThis;
			...
			t.__sysprofLastSeen.set(e.pid, y);
		}
		try {
			...
			if (this.currentHandlePid = 0, m) {
				const t = performance.now() - y, s = globalThis;
		...
		const w = Number(l.getBigInt64(56, !0)), k = l.getUint32(64, !0);
		w > 0 && this.ensureProcessMemoryCovers(e.pid, e.memory, i, w, n);
		const b = this.highControlFloorForProcess(e.pid);
		if (i === Tt && w > 0 && w >>> 0 != 4294967295) {
			const t = w >>> 0, i = n[1] >>> 0;
		...
		if (i === Rt && w > 0 && w >>> 0 != 4294967295) {
			const t = w >>> 0, i = n[2] >>> 0;
			null !== b && t + i > b && console.error(`[MREMAP ALERT] pid=${e.pid} mremap returned 0x${t.toString(16)} len=${i} — OVERLAPS THREAD REGION!`);
		}
		if (null !== b && i === Ot && w > b && console.error(`[BRK ALERT] pid=${e.pid} brk returned 0x${(w >>> 0).toString(16)} — IN THREAD REGION!`), i === Tt && w > 0 && w >>> 0 != 4294967295) {
			const t = n[4], i = n[3] >>> 0;
			if (t >= 0 && !(32 & i) && (this.populateMmapFromFile(e, w >>> 0, n), 1 & i)) {
				const i = n[5] >>> 0;
				let s = this.sharedMappings.get(e.pid);
				s || (s = /* @__PURE__ */ new Map(), this.sharedMappings.set(e.pid, s)), s.set(w >>> 0, {
					fd: t,
					fileOffset: 4096 * i,
					len: n[1] >>> 0
				});
		...
		i === $t && 0 === w && this.flushSharedMappings(e, n), i === zt && 0 === w && (this.flushSharedMappings(e, n), this.cleanupSharedMappings(e.pid, n[0] >>> 0, n[1] >>> 0));
		const I = this.kernelInstance.exports.kernel_get_process_exit_status;
		if (I && I(e.pid) >= 128) this.handleProcessTerminated(e);
		else {
			if (i === ri && 0 === w && this.drainMqueueNotification(), this.dequeueSignalForDelivery(e), -1 === w && k === it) return c && console.error(h + " = -1 (EAGAIN, will retry)"), void this.handleBlockingRetry(e, i, n);
			this.handleSleepDelay(e, i, n, w, k) || (0 !== k || i !== Bt && i !== St || this.recheckDeferredWaitpids(), 0 === k && i === yt && (this.scheduleWakeBlockedRetries(), this.reapKilledProcessesAfterSyscall()), c && console.error(h + this.formatSyscallReturn(i, w, k)), this.completeChannel(e, i, n, f, w, k));
		}
	}
	dequeueSignalForDelivery(e) {
		const t = this.kernelInstance.exports.kernel_dequeue_signal;
		if (!t) return;
		const i = this.scratchOffset + y;
		if (t(e.pid, this.toKernelPtr(i)) > 0) {
			const t = this.getKernelMem();
			new Uint8Array(e.memory.buffer).set(t.subarray(i, i + 44), e.channelOffset + y);
		} else {
			const t = e.channelOffset + y;
	...
	handlePselect6(e, t) {
		...
		if (this.dequeueSignalForDelivery(e), -1 === y && w === it) {
		...
		this.completeChannel(e, ht, t, void 0, y, w);
	}
	...
	handleLargeWrite(e, t, i) {
		...
		for (; u < r;) {
			...
			if (-1 === m && y === it) return u > 0 ? (this.completeChannelRaw(e, u, 0), void this.relistenChannel(e)) : void this.handleBlockingRetry(e, t, i);
			if (0 !== y || m <= 0) return u > 0 ? this.completeChannelRaw(e, u, 0) : this.completeChannelRaw(e, m, y), void this.relistenChannel(e);
	...
	handleLargeRead(e, t, i) {
		const n = i[0], s = i[1], r = i[2], o = t === Wt;
		let a = o ? i[3] : 0;
		const c = new Uint8Array(e.memory.buffer), h = this.getKernelMem(), l = new DataView(this.kernelMemory.buffer, this.scratchOffset), d = this.scratchOffset + 72, f = this.kernelInstance.exports.kernel_handle_channel;
		let u = 0;
		for (; u < r;) {
	...
	handleSendmsg(e, t) {
		...
		if (0 !== d && f > 0 && k + f <= 65536) {
			const e = h + k;
			a.set(r.subarray(d, d + f), e), w.setUint32(y, e, !0), k += f, k = k + 3 & -4;
		}
		if (0 !== g && m > 0 && k + m <= 65536) {
			const e = h + k;
			a.set(r.subarray(g, g + m), e), w.setUint32(y + 16, e, !0), k += m, k = k + 3 & -4;
		}
		const b = 8 === l ? 16 : 8;
		if (p > 0 && 0 !== u) {
			const e = h + k;
			...
			for (let t = 0; t < p; t++) {
				...
				if (8 === l ? (i = Number(o.getBigUint64(u + t * b, !0)), n = Number(o.getBigUint64(u + t * b + 8, !0))) : (i = o.getUint32(u + 8 * t, !0), n = o.getUint32(u + 8 * t + 4, !0)), w.setUint32(e + 8 * t, 0, !0), w.setUint32(e + 8 * t + 4, n, !0), n > 0 && k + n <= 65536) {
					const s = h + k;
					a.set(r.subarray(i, i + n), s), w.setUint32(e + 8 * t, s, !0), k += n, k = k + 3 & -4;
				}
			}
		}
		c.setUint32(4, qt, !0), c.setBigInt64(8, BigInt(i), !0), c.setBigInt64(16, BigInt(y), !0), c.setBigInt64(24, BigInt(s), !0);
	...
	handleRecvmsg(e, t) {
		...
		w.setUint32(y, d, !0), w.setUint32(y + 4, f, !0), w.setUint32(y + 8, u, !0), w.setUint32(y + 12, p, !0), w.setUint32(y + 16, g, !0), w.setUint32(y + 20, m, !0), w.setUint32(y + 24, 0, !0);
		let k = 28, b = 0;
		0 !== d && f > 0 && k + f <= 65536 && (b = h + k, a.fill(0, b, b + f), w.setUint32(y, b, !0), k += f, k = k + 3 & -4);
		let I = 0;
		0 !== g && m > 0 && k + m <= 65536 && (I = h + k, a.fill(0, I, I + m), w.setUint32(y + 16, I, !0), k += m, k = k + 3 & -4);
		const v = [], x = 8 === l ? 16 : 8;
		if (p > 0 && 0 !== u) {
			const e = h + k;
			k += 8 * p, k = k + 3 & -4, w.setUint32(y + 8, e, !0);
			for (let t = 0; t < p; t++) {
				...
				if (8 === l ? (i = Number(o.getBigUint64(u + t * x, !0)), n = Number(o.getBigUint64(u + t * x + 8, !0))) : (i = o.getUint32(u + 8 * t, !0), n = o.getUint32(u + 8 * t + 4, !0)), n > 0 && k + n <= 65536) {
					const s = h + k;
					a.fill(0, s, s + n), w.setUint32(e + 8 * t, s, !0), w.setUint32(e + 8 * t + 4, n, !0), v.push({
						base: i,
						len: n,
						kernelBase: s
					}), k += n, k = k + 3 & -4;
		...
		c.setUint32(4, Gt, !0), c.setBigInt64(8, BigInt(i), !0), c.setBigInt64(16, BigInt(y), !0), c.setBigInt64(24, BigInt(s), !0);
		...
		const S = w.getUint32(y + 4, !0), A = w.getUint32(y + 20, !0), M = w.getUint32(y + 24, !0);
		8 === l ? (o.setUint32(n + 8, S, !0), o.setUint32(n + 40, A, !0), o.setUint32(n + 44, M, !0)) : (o.setUint32(n + 4, S, !0), o.setUint32(n + 20, A, !0), o.setUint32(n + 24, M, !0)), this.completeChannel(e, Gt, t, void 0, P, B);
	}
	handleFork(e, t) {
	...
	handleSpawn(e, t) {
		...
		(async () => {
			...
			if (!((s = n) instanceof ArrayBuffer) && "errno" in s && "number" == typeof s.errno) return void this.completeChannel(e, vt, t, void 0, -1, n.errno >>> 0);
			var s;
			const r = n instanceof ArrayBuffer ? n : n.programBytes, c = n instanceof ArrayBuffer ? f : n.argv;
			this.handleSpawnAfterResolve(e, t, i, a, d, o, c, u, r);
		}).catch((n) => {
	...
	handleExec(e, t) {
		...
		s && !s.startsWith("/") && (s = this.resolveExecPathAgainstCwd(e.pid, s)), this.callbacks.onExec ? this.callbacks.onExec(e.pid, s, r, o).then((i) => {
			i < 0 && this.completeChannel(e, wt, t, void 0, -1, -i >>> 0);
		}).catch((i) => {
			console.error(`[kernel] exec error for pid ${e.pid}:`, i), this.completeChannel(e, wt, t, void 0, -1, 5);
		}) : this.completeChannel(e, wt, t, void 0, -1, 38);
	}
	...
	completeWaitpid(e, t, i, n) {
		this.dequeueSignalForDelivery(e), this.completeChannel(e, At, t, void 0, i, n);
	}
	wakeWaitingParent(e) {
		let t, i = -1;
		...
		this.waitingForChild.splice(i, 1), n.syscallNr === Mt ? (this.writeSignalInfo(n.channel, n.origArgs[2], t.childPid, t.waitStatus), n.options & Ut || this.consumeExitedChild(e, t.childPid), this.dequeueSignalForDelivery(n.channel), this.completeChannel(n.channel, Mt, n.origArgs, void 0, 0, 0)) : (this.consumeExitedChild(e, t.childPid), this.writeWaitStatus(n.channel, n.origArgs[1], t.waitStatus), this.completeWaitpid(n.channel, n.origArgs, t.childPid, 0));
	}
	recheckDeferredWaitpids() {
		for (let e = this.waitingForChild.length - 1; e >= 0; e--) {
			...
			"error" === i.kind && (this.waitingForChild.splice(e, 1), t.syscallNr === Mt ? this.completeChannel(t.channel, Mt, t.origArgs, void 0, -1, i.errno) : this.completeWaitpid(t.channel, t.origArgs, -1, i.errno));
		}
	}
	handleWaitid(e, t) {
		const i = t[0], n = t[1], s = t[2], r = t[3] >>> 0, o = e.pid, a = this.waitidToWaitPid(i, n), c = this.pollWaitableChild(o, a);
		if ("error" !== c.kind) {
			if ("exited" === c.kind) return this.writeSignalInfo(e, s, c.childPid, c.waitStatus), r & Ut || this.consumeExitedChild(o, c.childPid), void this.completeChannel(e, Mt, t, void 0, 0, 0);
			if (1 & r) {
				if (0 !== s) {
					const t = new DataView(e.memory.buffer);
					t.setInt32(s, 0, !0), t.setInt32(s + 12, 0, !0);
				}
				this.completeChannel(e, Mt, t, void 0, 0, 0);
		...
		} else this.completeChannel(e, Mt, t, void 0, -1, c.errno);
	}
	waitidToWaitPid(e, t) {
	...
	sendSignalToProcess(e, t) {
		...
		const i = new DataView(this.kernelMemory.buffer, this.scratchOffset);
		i.setUint32(4, yt, !0), i.setBigInt64(8, BigInt(e), !0), i.setBigInt64(16, BigInt(t), !0);
	...
	ensureProcessMemoryCovers(e, t, i, n, s) {
		let r = 0, o = 0, a = 0;
		i === Ot ? n >= 0 && (r = n) : i === Tt ? n >= 0 && (o = n, a = s[1], r = o + a) : i === Rt && n >= 0 && (o = n, a = s[2], r = o + a);
	...
	populateMmapFromFile(e, t, i) {
		...
		for (; l < s;) {
			...
			a.setUint32(4, Wt, !0), a.setBigInt64(8, BigInt(n), !0), a.setBigInt64(16, BigInt(h), !0), a.setBigInt64(24, BigInt(i), !0), a.setBigInt64(32, BigInt(4294967295 & r), !0), a.setBigInt64(40, BigInt(0 | Math.floor(r / 4294967296)), !0), a.setBigInt64(48, BigInt(0), !0), this.currentHandlePid = e.pid, this.bindKernelTidForChannel(e);
			try {
				o(this.toKernelPtr(this.scratchOffset), e.pid);
			} catch {
				break;
	...
	async sendHttpRequest(e, t, i = {}) {
		...
		if (y < m.length) throw d(0, p), f(0, g), /* @__PURE__ */ new Error(`[in-kernel-http ${s}] partial write ${y}/${m.length}`);
		this.notifyPipeReadable(p);
		const w = await this.pumpHttpResponse(0, g, p, h, l, f, d, n, s), k = i.emptyResponseRetries ?? 1;
	...
	handleIncomingTcpConnection(e, t, i, n) {
		...
		const I = this.tcpScratchOffset, v = this.kernelInstance.exports.kernel_pipe_is_write_open, x = () => {
			...
			for (; y.length > 0;) {
				const t = y[0], i = Math.min(t.length, 65536);
				e.set(t.subarray(0, i), I);
				const n = u(0, d, this.toKernelPtr(I), i);
				if (n <= 0) break;
				n >= t.length ? y.shift() : y[0] = t.subarray(n);
			}
			w && 0 === y.length && g(0, d);
		}, _ = () => {
			const e = this.getKernelMem();
			...
			if (k = !1, b || !this.processes.has(e)) return void M();
			x();
			const t = _();
			if (0 === v(0, f) && 0 === t) return i.destroyed || i.end(), void M();
			P();
		};
		i.on("data", (t) => {
			y.push(t), this.processes.has(e) ? (x(), this.notifyPipeReadable(d, e), P()) : M();
		}), i.on("end", () => {
			w = !0, P();
		}), i.on("error", () => {
			w = !0, i.destroy();
		...
		let S = this.tcpConnections.get(e);
		S || (S = [], this.tcpConnections.set(e, S));
		const A = {
			sendPipeIdx: f,
			scratchOffset: I,
			clientSocket: i,
	...
	handleIpcShmat(e, t) {
		...
		c.setUint32(4, Tt, !0), c.setBigInt64(8, BigInt(0), !0), c.setBigInt64(16, BigInt(a), !0), c.setBigInt64(24, BigInt(3), !0), c.setBigInt64(32, BigInt(34), !0), c.setBigInt64(40, BigInt(-1), !0), c.setBigInt64(48, BigInt(0), !0);
		...
		this.ensureProcessMemoryCovers(e.pid, e.memory, Tt, l, [
			0,
			a,
			3,
			34,
...
var xi = class {
	...
	machineOwnsAddress(e, t) {
		return t === wi || this.addressOwners.get(t) === e;
	}
	trackTcpPeer(e, t) {
	...
	connectStatus(e) {
		...
		return void 0 !== t ? t : this.connections.has(e) ? 0 : yi;
	}
	send(e, t, i) {
		const n = this.connections.get(e);
		if (!n) throw Object.assign(/* @__PURE__ */ new Error("ENOTCONN"), { errno: yi });
		return n.send(t, i);
	}
	recv(e, t, i) {
		const n = this.connections.get(e);
	...
	poll(e, t) {
		...
		if (!i) throw Object.assign(/* @__PURE__ */ new Error("ENOTCONN"), { errno: yi });
...
var Ci = class {
	...
	constructor() {
		...
		this.devices.set("null", Bi), this.devices.set("zero", Si), this.devices.set("urandom", e), this.devices.set("random", e), this.devices.set("console", Ai), this.devices.set("tty", Ai), this.deviceNames = [...this.devices.keys()];
	}
	getDevice(e) {
	...
	statfs(e) {
		...
		return t.files = this.devices.size + Mi.length + Ei.length, t;
	}
	mkdir(e, t) {
	...
	opendir(e) {
		...
		if (Ui(e)) i = [...this.deviceNames.map((e, t) => ({
			...
			type: 2,
			ino: t + 1
		})), ...Ei.filter((e) => !this.devices.has(e.name))];
		else {
			if (!Mi.includes(t)) throw new Error("ENOTDIR");
			i = [];
		}
...
}, Ti = ArrayBuffer, zi = Uint8Array, Oi = Uint16Array, Ri = Int16Array, $i = Int32Array, Ni = function(e, t, i) {
	if (zi.prototype.slice) return zi.prototype.slice.call(e, t, i);
	(null == t || t < 0) && (t = 0), (null == i || i > e.length) && (i = e.length);
	var n = new zi(i - t);
	return n.set(e.subarray(t, i)), n;
}, Fi = function(e, t, i, n) {
	if (zi.prototype.fill) return zi.prototype.fill.call(e, t, i, n);
	for ((null == i || i < 0) && (i = 0), (null == n || n > e.length) && (n = e.length); i < n; ++i) e[i] = t;
	return e;
}, Wi = function(e, t, i, n) {
	if (zi.prototype.copyWithin) return zi.prototype.copyWithin.call(e, t, i, n);
	...
	s > i && Di(3);
	for (var r = 1 << s, o = r, a = -1, c = -1, h = -1, l = r, d = new Ti(512 + (r << 2)), f = new Ri(d, 0, 256), u = new Oi(d, 0, 256), p = new Oi(d, 512, r), g = 512 + (r << 1), m = new zi(d, g, r), y = new zi(d, g + r); a < 255 && o > 0;) {
		var w = Hi(o + 1), k = n >> 3, b = (1 << w + 1) - 1, I = (e[k] | e[k + 1] << 8 | e[k + 2] << 16) >> (7 & n) & b, v = (1 << w) - 1, x = b - o - 1, _ = I & v;
		if (_ < x ? (n += w, I = _) : (n += w + 1, I > v && (I -= x)), f[++a] = --I, -1 == I ? (o += I, m[--l] = a) : o -= I, !I) do {
			var P = n >> 3;
			c = (e[P] | e[P + 1] << 8) >> (7 & n) & 3, n += 2, a += c;
		} while (3 == c);
	}
	(a > 255 || o) && Di(0);
	for (var B = 0, S = (r >> 1) + (r >> 3) + 3, A = r - 1, M = 0; M <= a; ++M) {
		var E = f[M];
		if (E < 1) u[M] = -E;
		else for (h = 0; h < E; ++h) {
			m[B] = M;
	...
	202050057,
	269422093
]).buffer, 0, 36), Zi = Yi(Ji, 0), Qi = new zi(new $i([
	0,
	0,
	0,
	0,
	...
	if (1 == o) {
		...
		return t.b = s + 1, i ? (Fi(i, e[s], t.y, t.y += a), i) : Fi(new zi(a), e[s]);
	}
	if (!(c > e.length)) {
		...
		if (2 == o) {
			...
			var g = i ? i.subarray(t.y, t.y + t.m) : new zi(t.m), m = g.length - f;
			if (0 == l) g.set(e.subarray(s, s += f), m);
			else if (1 == l) Fi(g, e[s++], m);
			else {
				var y = t.h;
				if (2 == l) {
					var w = function(e, t) {
						var i = 0, n = -1, s = new zi(292), r = e[t], o = s.subarray(0, 256), a = s.subarray(256, 268), c = new Oi(s.buffer, 268);
						if (r < 128) {
							var h = qi(e, t + 1, 6), l = h[0], d = h[1], f = l << 3, u = e[t += r];
							u || Di(0);
							for (var p = 0, g = 0, m = d.b, y = m, w = (++t << 3) - 8 + Hi(u); !((w -= m) < f);) {
								var k = w >> 3;
						...
						var B = new zi(x << 1), S = B.subarray(0, x), A = B.subarray(x);
						for (c[v] = 0, i = v; i > 0; --i) {
							var M = c[i];
							Fi(A, i, M, c[i - 1] = M + a[i] * (1 << v - i));
						}
						for (c[0] != x && Di(0), i = 0; i < n; ++i) {
							var E = o[i];
							if (E) {
								var U = c[E];
								Fi(S, i, U, c[E] = U + (1 << v - E));
							}
						}
						return [t, {
							n: A,
				...
				(p ? nn : tn)(e.subarray(s, s += u), g.subarray(m), y);
			}
			var k = e[s++];
			if (k) {
				...
				var P = t.t = I, B = P[0], S = P[1], A = P[2], M = e[c - 1];
				M || Di(0);
				var E = (c << 3) - 8 + Hi(M) - A.b, U = E >> 3, C = 0, T = (e[U] | e[U + 1] << 8) >> (7 & E) & (1 << A.b) - 1, z = (e[U = (E -= S.b) >> 3] | e[U + 1] << 8) >> (7 & E) & (1 << S.b) - 1, O = (e[U = (E -= B.b) >> 3] | e[U + 1] << 8) >> (7 & E) & (1 << B.b) - 1;
				for (++k; --k;) {
					var R = A.s[T], $ = A.n[T], N = B.s[O], F = B.n[O], W = S.s[z], L = S.n[z], D = 1 << W, K = D + ((e[U = (E -= W) >> 3] | e[U + 1] << 8 | e[U + 2] << 16 | e[U + 3] << 24) >>> (7 & E) & D - 1);
					U = (E -= Qi[N]) >> 3;
					var V = en[N] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & E) & (1 << Qi[N]) - 1);
					U = (E -= Ji[R]) >> 3;
					var H = Zi[R] + ((e[U] | e[U + 1] << 8 | e[U + 2] << 16) >> (7 & E) & (1 << Ji[R]) - 1);
					if (U = (E -= $) >> 3, T = A.t[T] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << $) - 1), U = (E -= F) >> 3, O = B.t[O] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << F) - 1), U = (E -= L) >> 3, z = S.t[z] + ((e[U] | e[U + 1] << 8) >> (7 & E) & (1 << L) - 1), K > 3) t.o[2] = t.o[1], t.o[1] = t.o[0], t.o[0] = K -= 3;
					else {
						var q = K - (0 != H);
...
function rn(e, t) {
	for (var i = [], n = +!t, s = 0, r = 0; e.length;) {
		...
		if ("object" == typeof o) {
			for (n ? (t = null, o.w.length == o.u && (i.push(t = o.w), r += o.u)) : (i.push(t), o.e = 0); !o.l;) {
				var a = sn(e, o, t);
				a || Di(5), t ? o.e = o.y : (i.push(a), r += a.length, Wi(o.w, 0, a.length), o.w.set(a, o.w.length - a.length));
			}
			s = o.b + 4 * o.c;
		} else s = o;
		e = e.subarray(s);
	...
	return function(e, t) {
		if (1 == e.length) return e[0];
		for (var i = new zi(t), n = 0, s = 0; n < e.length; ++n) {
			var r = e[n];
...
const yn = new TextEncoder(), wn = new TextDecoder();
function kn(e) {
	return e.buffer instanceof SharedArrayBuffer ? wn.decode(new Uint8Array(e)) : wn.decode(e);
}
function bn(e) {
	return e + 3 & -4;
}
var In = class e {
	...
	static mkfs(t, i) {
		...
		if (y < 0) throw new mn(-28);
		u.w32(m + fn, y);
		const w = y * on, k = bn(9), b = bn(10);
	...
	pathResolve(e, t) {
		...
		for (let r = 0; r < n.length; r++) {
			...
			const a = yn.encode(e), c = this.dirLookup(i, a);
			if (c < 0) return c;
			...
			if (40960 == (61440 & this.r32(h + 8)) && (r !== n.length - 1 || t)) {
				...
				if (e <= 40) t = kn(this.u8.subarray(h + fn, h + fn + e));
					...
					this.inodeReadData(c, 0, i, e), t = wn.decode(i);
				}
				if (t.startsWith("/")) {
					i = 1;
	...
	open(e, t, i = 420) {
		...
		if (r < 0 && -2 === r && s) {
			...
			try {
				const e = yn.encode(n), s = this.dirLookup(t, e);
				if (s >= 0) r = s;
				else {
	...
	unlink(e) {
		const { parentIno: t, name: i } = this.pathResolveParent(e), n = yn.encode(i);
		this.inodeWriteLock(t);
		try {
	...
	rename(e, t) {
		const { parentIno: i, name: n } = this.pathResolveParent(e), { parentIno: s, name: r } = this.pathResolveParent(t), o = yn.encode(n), a = yn.encode(r), c = Math.min(i, s), h = Math.max(i, s);
	...
	mkdir(e, t = 493) {
		const { parentIno: i, name: n } = this.pathResolveParent(e), s = yn.encode(n);
	...
	symlink(e, t) {
		const { parentIno: i, name: n } = this.pathResolveParent(t), s = yn.encode(n), r = yn.encode(e);
		this.inodeWriteLock(i);
		try {
			if (this.dirLookup(i, s) >= 0) throw new mn(-17);
			const e = this.inodeAlloc();
	...
	link(e, t) {
		...
		const { parentIno: s, name: r } = this.pathResolveParent(t), o = yn.encode(r);
	...
	readlink(e) {
		...
		try {
			...
			return this.inodeReadData(t, 0, e, n), wn.decode(e);
		} finally {
			this.inodeReadUnlock(t);
		}
	}
	...
	writeFile(e, t) {
		const i = "string" == typeof t ? yn.encode(t) : t, n = this.open(e, 577);
		try {
			this.write(n, i);
		} finally {
			this.close(n);
	...
	readFileText(e) {
		return wn.decode(this.readFile(e));
	}
};
const vn = [
	40,
...
var Mn = class e {
	...
	rebaseToNewFileSystem(t) {
		...
		const i = Math.min(t, Math.max(this.sharedBuffer.byteLength, 16777216)), n = new SharedArrayBuffer(i, { maxByteLength: t }), s = e.create(n, t);
	...
	copyPathToFreshFileSystem(t, i, n, s) {
		const r = this.lstat(t), o = 61440 & r.mode, a = 4095 & r.mode;
		if (16384 === o) {
			"/" === t ? (i.chown(t, r.uid, r.gid), i.chmod(t, a)) : i.mkdirWithOwner(t, a, r.uid, r.gid);
			const o = this.opendir(t);
			try {
				for (;;) {
					const e = this.readdir(o);
					if (!e) break;
					"." !== e.name && ".." !== e.name && this.copyPathToFreshFileSystem("/" === t ? `/${e.name}` : `${t}/${e.name}`, i, n, s);
				}
			} finally {
				this.closedir(o);
			}
		...
		if (40960 !== o) {
			...
			if (n.has(t) || s.has(t)) return i.createFileWithOwner(t, a, r.uid, r.gid, new Uint8Array(0)), void e.applyTimes(i, t, r);
			this.copyRegularFileToFreshFileSystem(t, i, r, a);
		} else i.symlinkWithOwner(this.readlink(t), t, r.uid, r.gid);
	}
	copyRegularFileToFreshFileSystem(t, i, n, s) {
		...
		try {
			...
			let a = n.size;
			for (; a > 0;) {
				const n = Math.min(e.byteLength, a), s = this.read(r, e, null, n);
				if (s <= 0) throw new Error(`Unexpected EOF while rebasing VFS file: ${t}`);
				let c = 0;
				for (; c < s;) {
					const n = i.write(o, e.subarray(c, s), null, s - c);
			...
			null !== o && i.close(o), this.close(r);
		}
		i.chown(t, n.uid, n.gid), i.chmod(t, s), e.applyTimes(i, t, n);
	}
	static applyTimes(e, t, i) {
		const n = Math.floor(i.atimeMs / 1e3), s = Math.floor(1e6 * (i.atimeMs - 1e3 * n)), r = Math.floor(i.mtimeMs / 1e3), o = Math.floor(1e6 * (i.mtimeMs - 1e3 * r));
		e.utimensat(t, n, s, r, o);
	}
	access(e, t) {
		this.fs.stat(e);
	}
...
function Tn(e, t, i = {}) {
	...
	for (const s of e) if ("image" === s.source) {
		const e = Mn.fromImage(t, { maxByteLength: 1073741824 });
		Cn(e), n.push({
			mountPoint: s.path,
			backend: e,
			readonly: s.readonly
		...
		const e = i.scratchSabBytes?.[s.path] ?? 16777216, t = new SharedArrayBuffer(e), r = Mn.create(t);
...
async function qn(e, t, i) {
	...
	const h = function(e, t, i, n) {
		const s = new zn([
			{
				mountPoint: "/dev/shm",
				backend: Mn.create(new SharedArrayBuffer(1048576))
			},
			{
				mountPoint: "/dev",
				backend: new Ci()
	...
	null !== y && p.setBrkBase(r, y), void 0 !== i.stdin && p.setStdinData(r, Rn.encode(i.stdin));
	const w = {
		...
		try {
			const e = await async function() {
				return Nn || (Nn = Promise.all([
					Hn("/kandelo/assets/kernel-QfL6EyIk.wasm"),
					Hn("/kandelo/assets/rootfs-MgReXPVU.vfs"),
