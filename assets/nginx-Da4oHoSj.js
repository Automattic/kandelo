import{k,B as v}from"./browser-kernel-3EHx8tzG.js";/* empty css               */import{n as b,H as B,l as P}from"./nginx-DS843j_U.js";const h="/wasm-posix-kernel/app/",l=document.getElementById("log"),g=document.getElementById("start"),x=document.getElementById("reload"),d=document.getElementById("status");let p=document.getElementById("frame");const f=new TextDecoder;function n(e,r){const i=document.createElement("span");r&&(i.className=r),i.textContent=e,l.appendChild(i),l.scrollTop=l.scrollHeight}function o(e,r){d.style.display="block",d.textContent=e,d.className=`status ${r}`}const _=`daemon off;
master_process on;
worker_processes 2;
