import{k as $,B as w}from"./browser-kernel-DeZfH_RD.js";/* empty css               */import{S as F}from"./terminal-panel-sc5ZsZwc.js";import{n as P,p as C}from"./nginx-Cq4QJjHN.js";import{p as E,a as I}from"./php-fpm-Deu4FVBk.js";import{C as O,p as B,w as M,a as c}from"./shell-binaries-DvtU7PcP.js";import{d as v,c as H,g as N,s as L}from"./sed-CaEQBVG8.js";import"./xterm-CyPUMFhC.js";const S="/wasm-posix-kernel/app/",U="/wasm-posix-kernel/service-worker.js",d=document.getElementById("log"),h=document.getElementById("start"),R=document.getElementById("reload"),g=document.getElementById("status"),W=document.getElementById("terminal-panel");let _=document.getElementById("frame");const b=new TextDecoder;function s(t,r){const n=document.createElement("span");r&&(n.className=r),n.textContent=t,d.appendChild(n),d.scrollTop=d.scrollHeight}function l(t,r){g.style.display="block",g.textContent=t,g.className=`status ${r}`}const A=`<?php
$uptime = time();
