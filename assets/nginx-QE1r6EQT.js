import{k as S,B as v}from"./browser-kernel-CeVfDkIW.js";/* empty css               */import{S as W}from"./terminal-panel-sc5ZsZwc.js";import{n as u,p as I}from"./nginx-B-LiObMC.js";import{C as P,p as C,w as L,a as f}from"./shell-binaries-DvtU7PcP.js";import{d as T,c as M,g as z,s as U}from"./sed-C3GaF0T-.js";import"./xterm-CyPUMFhC.js";const k="/wasm-posix-kernel/app/",$="/wasm-posix-kernel/service-worker.js",l=document.getElementById("log"),m=document.getElementById("start"),w=document.getElementById("reload"),c=document.getElementById("status"),F=document.getElementById("terminal-panel");let h=document.getElementById("frame");const y=new TextDecoder;function i(n,t){const r=document.createElement("span");t&&(r.className=t),r.textContent=n,l.appendChild(r),l.scrollTop=l.scrollHeight}function o(n,t){c.style.display="block",c.textContent=n,c.className=`status ${t}`}const A=`<!DOCTYPE html>
<html>
<head>
