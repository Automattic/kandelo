...
`,"info"),M()}catch(e){m(`
Error: ${e}
`,"stderr"),c(`Error: ${e}`,"error"),console.error(e)}finally{B.disabled=!1}}B.addEventListener("click",A);v.addEventListener("change",()=>{const e=v.value;e&&I[e]&&(O.value=I[e]),v.value=""});O.addEventListener("keydown",e=>{(e.ctrlKey||e.metaKey)&&e.key==="Enter"&&(e.preventDefault(),A())});
