import{B as _,k as g}from"./browser-kernel-BPDGIj33.js";const S="/wasm-posix-kernel/assets/php-C7j_pN9j.wasm",m=document.getElementById("code"),r=document.getElementById("output"),u=document.getElementById("run"),l=document.getElementById("examples"),a=document.getElementById("status"),f=new TextDecoder,T=new TextEncoder;function s(e,n){const t=document.createElement("span");n&&(t.className=n),t.textContent=e,r.appendChild(t),r.scrollTop=r.scrollHeight}function d(e,n){a.style.display="block",a.textContent=e,a.className=`status ${n}`}function w(){a.style.display="none"}const E={hello:`<?php
