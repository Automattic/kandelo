...
package_publish_flow_changed_files() {
  grep -E \
    ...
    -e '^\.github/workflows/(staging-build|prepare-merge|activate-merge-candidate|recover-rejected-merge-candidate|staging-cleanup|force-rebuild|reusable-package-source-publish|verify-integration-batch|finalize-integration-batch)\.yml$' \
