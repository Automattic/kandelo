...
// `spawnFromVfs`) THROUGH the in-kernel rootfs overlay instead of the host
// `/` mount. Used when `kernelRootfsEnabled()` so the overlay is the sole
// source of exec bytes ahead of the `/` mount removal (w5 Task 2). ENOENT/
