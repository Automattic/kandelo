...
export const STRUCT_SIZE_WASM_STAT = 96 as const;
...
export const IOCTL_REQUESTS: Record<number, IoctlRequestContract> = {
  ...
  3222299872: { argKind: "pointer", direction: "inout", wasm32Size: 16, wasm64Size: 16 },
  3222299873: { argKind: "pointer", direction: "inout", wasm32Size: 16, wasm64Size: 16 },
...
export const IOCTL_REQUEST_FAMILIES: IoctlRequestFamily[] = [
  ...
  { dir: 2, magic: 69, nrFirst: 7, nrLast: 9, direction: "out", fixedSize: null, maxCallerSize: 256 },
  { dir: 2, magic: 69, nrFirst: 24, nrLast: 27, direction: "out", fixedSize: null, maxCallerSize: 256 },
