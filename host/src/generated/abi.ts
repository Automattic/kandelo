...
export const SYSCALL_ARGS: Record<number, SyscallArgDesc[]> = {
  ...
  209: [
    { argIndex: 0, direction: "in", size: { type: "process-layout", wasm32Size: 12, wasm64Size: 24 } },
    { argIndex: 1, direction: "out", size: { type: "process-layout", wasm32Size: 12, wasm64Size: 24 } },
  ],
  211: [
    { argIndex: 0, direction: "in", size: { type: "cstring" } },
  ],
  ...
  225: [
    ...
    { argIndex: 2, direction: "out", size: { type: "process-layout", wasm32Size: 16, wasm64Size: 32 } },
  ],
  230: [
  ...
  331: [
    { argIndex: 0, direction: "in", size: { type: "cstring" } },
    { argIndex: 3, direction: "in", size: { type: "process-layout", wasm32Size: 32, wasm64Size: 64 } },
  ],
  332: [
    { argIndex: 0, direction: "in", size: { type: "cstring" } },
  ],
  ...
  335: [
    { argIndex: 1, direction: "in", size: { type: "process-layout", wasm32Size: 64, wasm64Size: 64 } },
  ],
  336: [
    { argIndex: 1, direction: "in", size: { type: "process-layout", wasm32Size: 32, wasm64Size: 64 } },
    { argIndex: 2, direction: "out", size: { type: "process-layout", wasm32Size: 32, wasm64Size: 64 } },
  ],
  342: [
