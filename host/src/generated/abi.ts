...
export const ABI_VERSION = 17 as const;
...
export const PROCESS_MEMORY_FORK_SAVE_BUFFER_SIZE = 49152 as const;
...
export type SyscallArgSizeSpec =
  ...
  | { type: "ioctl_encoded"; argIndex: number; floor: number };
...
export const SYSCALL_ARGS: Record<number, SyscallArgDesc[]> = {
  ...
  6: [
    { argIndex: 1, direction: "out", size: { type: "fixed", size: 96 } },
  ],
  9: [
  ...
  72: [
    { argIndex: 2, direction: "inout", size: { type: "ioctl_encoded", argIndex: 1, floor: 256 } },
  ],
  75: [
  ...
  93: [
    { argIndex: 1, direction: "in", size: { type: "cstring" } },
    { argIndex: 2, direction: "out", size: { type: "fixed", size: 96 } },
  ],
  94: [
    { argIndex: 1, direction: "in", size: { type: "cstring" } },
  ],
