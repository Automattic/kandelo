...
export const ABI_VERSION = 44 as const;
...
export const WPK_FORK_REQUIRED_IMPORTS = [
  ...
  { module: "env", name: "__wpk_fork_module_state_table_catalog_function", params: ["i32"], results: ["funcref"] },
  { module: "env", name: "__wpk_fork_module_state_table_catalog_index", params: ["funcref"], results: ["i32"] },
  ...
  { module: "env", name: "__wpk_fork_module_state_table_mutation_commit", params: ["i32", "i32", "i64", "i64"], results: [] },
...
export const WPK_FORK_REQUIRED_EXPORTS = [
  ...
  { name: "wpk_fork_module_table_apply", params: ["i32", "i32", "ptr", "i32"], results: [] },
  { name: "wpk_fork_module_table_length", params: ["i32"], results: ["i32"] },
  { name: "wpk_fork_module_table_read", params: ["i32", "i32"], results: ["i32"] },
...
export const STRUCT_SIZE_KERNEL_SHARED_MAPPING_FD_FACTS = 48 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_DEV_OFFSET = 0 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_INO_OFFSET = 8 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_SIZE_OFFSET = 16 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_HOST_HANDLE_OFFSET = 24 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_MODE_OFFSET = 32 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_ACCESS_MODE_OFFSET = 36 as const;
export const KERNEL_SHARED_MAPPING_FD_FACTS_HAS_HOST_HANDLE_OFFSET = 40 as const;
