...
export class CentralizedKernelWorker {
  ...
  */
  ...
  private handleExit(channel: ChannelInfo, syscallNr: number, origArgs: number[]): void {
    ...
    // A normal return does not by itself prove that Rust committed the exit
    // transition. Do not turn an incomplete transaction into a successful
    // guest exit or a host-authored zombie.
