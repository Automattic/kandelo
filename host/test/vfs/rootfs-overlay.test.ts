...
describe("browser rootfs /etc overlay", () => {
  it("recursively copies nested files and symlinks while preserving caller leaves", async () => {
    ...
    // Existing directory ownership and mode remain caller-owned even though
