  ...
  it.skipIf(!programBinary)(
    ...
    async () => {
      ...
      try {
        ...
        /* F2 switches to the sound shader, which compiles +
        ...
        /* The chip synth initializes against the granted audio
        ...
        /* The sound-shader pipeline initialized, and F2 switched
         * to sound mode and ran a render+readback dispatch. The track is
         * rendered as multiple time-tiles; under the headless GL
