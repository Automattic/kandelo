/**
 * End-to-end gate for the evdev path. Spawns `input-evdev-smoke`
 * inside the centralized kernel, then drives `kernel_input_event`
 * from the host via `NodeKernelHost.injectInputEvent` — the same shape
 * a real `BrowserInputSource` drives.
 *
