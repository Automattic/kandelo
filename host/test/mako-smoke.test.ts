...
`,
      ...
      try {
        ...
        // the enter has to arrive before the first frame.
        ...
        // The toast drew at the output's scale, and drew at it first: a toast
        // lives for one frame, so a scale-1 frame is a permanently soft toast.
        // Reaching this also proves mako's second set_size was answered — it
        // asks for a toast one pixel shorter once it knows the scale, and it
        // blocks until the configure for that size comes back.
