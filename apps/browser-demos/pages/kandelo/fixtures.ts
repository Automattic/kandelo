...
export const PRESET_LIBRARY: Preset[] = [
  ...
  { id: "wordpress-development", title: "WordPress Development", summary: "A shallow-cloned wordpress-develop repo with MariaDB, PHPUnit, Node, npm, and dev scripts.",
    base: "kandelo:shell@abi8",
    packages: ["dinit@local", "nginx@local", "php@local", "php-fpm@local", "mariadb@local", "node@local", "npm@local", "phpunit@local", "wordpress-develop@git"],
    accent: "#3858e9", glyph: "dev", bootCommand: ["/sbin/dinit", "--container", "-p", "/tmp/dinitctl"], estimatedUrlBytes: 1880 },
