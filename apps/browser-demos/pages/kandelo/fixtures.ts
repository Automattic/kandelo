...
export const PRESET_LIBRARY: Preset[] = [
  ...
  { id: "wordpress-sqlite", title: "WordPress SQLite", summary: "WordPress served from the VFS with the SQLite database plugin.",
    base: "kandelo:shell@abi8",
  ...
  { id: "wordpress-mariadb", title: "WordPress MariaDB", summary: "WordPress served from the VFS with MariaDB.",
    base: "kandelo:shell@abi8",
    packages: ["lamp@local", "mariadb@local", "dinit@local", "nginx@local", "php-fpm@local", "bash@local", "coreutils@local"],
