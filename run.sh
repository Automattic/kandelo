...
cmd_list() {
    ...
    echo "  ./run.sh --pr-staging --fetch-only prepare-browser"
    echo "                                        Materialize PR staging browser assets"
    echo "                                        without source-build fallback."
    echo "  ./run.sh --pr-staging browser        Start browser using current PR staging"
    echo "                                        archives when package cache keys drift."
    echo ""
