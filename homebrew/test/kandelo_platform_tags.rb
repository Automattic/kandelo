...
def assert_tag_round_trip(symbol, arch)
  ...
  assert_equal("/opt/kandelo/homebrew", tag.default_prefix, "#{symbol} default_prefix")
  assert_equal("/opt/kandelo/homebrew/Cellar", tag.default_cellar, "#{symbol} default_cellar")
end
...
spec.sha256 cellar: "/opt/kandelo/homebrew/Cellar",
...
assert_equal("/opt/kandelo/homebrew/Cellar", wasm64_spec.cellar, "wasm64 formula cellar")
