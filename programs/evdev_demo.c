/*
 * evdev_demo — runtime backing for `/?demo=evdev`.
 *
 ...
 * kernel-side WpkInputEvent layout. input-evdev-smoke.c inlines its own
 * definitions on purpose, so that fixture's ABI check stays independent
 * of this header.
 */
#include <errno.h>
#include <fcntl.h>
