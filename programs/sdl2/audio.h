 ...
 * playground: the chip synth, the FFT and the iAudio uniform.
 *
 ...
 *      SDL audio callback and runs on SDL's audio thread; main-loop
 *      writes to the state it reads hold SDL_LockAudioDevice.
 *
...
/* Switch the playback source to a sound-shader-rendered S16
