...
// with a re-export shim here pointing back at it, which inverted the
// dependency: the only callers are in this directory, and `host/src/index.ts`
// never exported it. Living under `host/src` also made
