 ...
 * `packages/registry/<name>/package.toml` `[source]` block the package
 ...
 * `packages/registry/cpython/cpython-src/`) already exists, the helper
 ...
 * recorded in `packages/registry/<packageName>/package.toml`'s `[source]`
