...
fn render_process_layouts_header() -> String {
    use shared::process_layout::{cmsghdr, iovec, msghdr, rt_sigqueueinfo, sigevent};
...
fn render_c_channel_contract() -> String {
    ...
    format!(
        "/* Shared syscall-channel status values. */\n\
         ...
         #define WASM_POSIX_CHANNEL_RESERVED_OFFSET {reserved_offset}u\n\
         #define WASM_POSIX_CHANNEL_RESERVED_SIZE {reserved_size}u\n\
        ...
        reserved_offset = channel::RESERVED_OFFSET,
        reserved_size = channel::RESERVED_SIZE,
...
mod tests {
    ...
    fn generated_channel_contract_covers_status_layout_and_signal_wire() {
        ...
        for expected in [
            ...
            "#define WASM_POSIX_CHANNEL_RESERVED_OFFSET 68u",
