...
static const char c_time[] =
	...
	"%a %b %e %T %Y\0"
	"%H:%M:%S\0"
	/* musl catalogs have one full and one abbreviated name per month.
	 * Use those names as the POSIX fallback when a locale has no distinct
	 * alternative grammatical form. */
	"January\0"   "February\0" "March\0"    "April\0"
	"May\0"       "June\0"     "July\0"     "August\0"
	"September\0" "October\0"  "November\0" "December\0"
	"Jan\0" "Feb\0" "Mar\0" "Apr\0" "May\0" "Jun\0"
